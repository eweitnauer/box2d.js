...
ClipVertex.prototype.id = new b2ContactID;var Features = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2CircleDef.prototype.radius = null;var b2CircleShape = function() {
...
b2MassData.prototype.I = 0;var b2PolygonDef = function() {
  b2ShapeDef.prototype.__varz.call(this);
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ShapeDef.prototype.filter = new b2FilterData;var b2AABB = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2BoundValues.prototype.upperValues = [0, 0];var b2BroadPhase = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2BufferedPair.prototype.proxyId2 = 0;var b2Collision = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactPoint.prototype.id = new b2ContactID;var b2Distance = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactConstraint.prototype.pointCount = 0;var b2ContactConstraintPoint = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactConstraintPoint.prototype.velocityBias = null;var b2ContactEdge = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactEdge.prototype.next = null;var b2ContactRegister = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactRegister.prototype.primary = null;var b2ContactResult = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactResult.prototype.id = new b2ContactID;var b2ContactSolver = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2GearJointDef.prototype.ratio = null;var b2Jacobian = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2JointDef.prototype.collideConnected = null;var b2JointEdge = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2JointEdge.prototype.next = null;var b2MouseJoint = function() {
  b2Joint.prototype.__varz.call(this);
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2MouseJointDef.prototype.timeStep = null;var b2PrismaticJoint = function() {
  b2Joint.prototype.__varz.call(this);
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2BodyDef.prototype.isBullet = null;var b2BoundaryListener = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2TimeStep.prototype.positionCorrection = null;var b2World = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
