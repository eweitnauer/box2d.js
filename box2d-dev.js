...
b2TimeStep.prototype.positionCorrection = null;var b2Point = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2BufferedPair.prototype.proxyId2 = 0;var b2PairCallback = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2MassData.prototype.I = 0;var b2Jacobian = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2JointEdge.prototype.next = null;var b2Collision = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2Collision.b2CollidePolygons = function(manifold, polyA, xfA, polyB, xfB) {
  ...
  var frontNormal = b2Math.b2CrossVF(sideNormal, 1);
...
b2JointDef.prototype.collideConnected = null;var b2BoundaryListener = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2Color.prototype.__constructor = function(rr, gg, bb) {
  this._r = parseInt(255 * b2Math.b2Clamp(rr, 0, 1));
  this._g = parseInt(255 * b2Math.b2Clamp(gg, 0, 1));
  this._b = parseInt(255 * b2Math.b2Clamp(bb, 0, 1))
};
...
b2PairManager.Hash = function(proxyId1, proxyId2) {
  var key = proxyId2 << 16 & 4294901760 | proxyId1;
...
b2ContactSolver.prototype.SolvePositionConstraints = function(baumgarte) {
  ...
  for(var i = 0;i < this.m_constraintCount;++i) {
    ...
    for(var j = 0;j < tCount;++j) {
      ...
      var C = baumgarte * b2Math.b2Clamp(separation + b2Settings.b2_linearSlop, -b2Settings.b2_maxLinearCorrection, 0);
...
b2BoundValues.prototype.upperValues = [0, 0];var b2PrismaticJointDef = function() {
...
b2MouseJointDef.prototype.timeStep = null;var b2XForm = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2Shape.prototype.TestSegment = function(xf, lambda, normal, segment, maxLambda) {
  return false
};
...
b2ContactConstraintPoint.prototype.velocityBias = null;var b2Segment = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactRegister.prototype.primary = null;var b2DestructionListener = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactEdge.prototype.next = null;var b2Sweep = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ContactConstraint.prototype.pointCount = 0;var b2OBB = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2OBB.prototype.extents = new b2Vec2;var b2Distance = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2Distance.InPoints = function(w, points, pointCount) {
  var k_tolerance = 100 * Number.MIN_VALUE;
...
b2BodyDef.prototype.isBullet = null;var b2BroadPhase = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2CircleShape.prototype.TestSegment = function(transform, lambda, normal, segment, maxLambda) {
  var tMat = transform.R;
...
b2Joint.prototype.GetReactionForce = function() {
  return null
};
...
b2GearJointDef.prototype.ratio = null;var b2ShapeDef = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2ShapeDef.prototype.restitution = 0;
b2ShapeDef.prototype.density = 0;
b2ShapeDef.prototype.isSensor = false;
b2ShapeDef.prototype.filter = new b2FilterData;var b2PolygonDef = function() {
...
b2PolygonShape.prototype.TestSegment = function(xf, lambda, normal, segment, maxLambda) {
  var lower = 0;
  var upper = maxLambda;
  var tX;
  var tY;
...
b2ContactPoint.prototype.id = new b2ContactID;var b2CircleDef = function() {
  b2ShapeDef.prototype.__varz.call(this);
  this.__varz();
  this.__constructor.apply(this, arguments)
};
extend(b2CircleDef.prototype, b2ShapeDef.prototype);
b2CircleDef.prototype._super = function() {
  b2ShapeDef.prototype.__constructor.apply(this, arguments)
};
...
b2CircleDef.prototype.localPosition = new b2Vec2(0, 0);
b2CircleDef.prototype.radius = null;var b2MouseJoint = function() {
  b2Joint.prototype.__varz.call(this);
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2MouseJoint.prototype.__constructor = function(def) {
  ...
  var omega = 2 * b2Settings.b2_pi * def.frequencyHz;
  var d = 2 * mass * def.dampingRatio * omega;
...
ClipVertex.prototype.id = new b2ContactID;var b2NullContact = function() {
...
b2ContactResult.prototype.id = new b2ContactID;var b2Island = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
b2Island.prototype.__constructor = function(bodyCapacity, contactCapacity, jointCapacity, allocator, listener) {
  var i = 0;
...
b2World.prototype.SetPositionCorrection = function(flag) {
