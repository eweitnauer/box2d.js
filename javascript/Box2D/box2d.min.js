...
b2Collision.b2CollidePolygons=function(a,c,b,d,e){var f=a.pointCount=0,g=[f],h=b2Collision.FindMaxSeparation(g,c,b,d,e);f=g[0];if(!(h>0)){var i=0;g=[i];var j=b2Collision.FindMaxSeparation(g,d,e,c,b);i=g[0];if(!(j>0)){var k=new b2XForm,l=new b2XForm,m=0;g=0;if(j>0.98*h+0.0010){h=d;d=c;k.Set(e);l.Set(b);m=i;g=1}else{h=c;d=d;k.Set(b);l.Set(e);m=f;g=0}c=[new ClipVertex,new ClipVertex];b2Collision.FindIncidentEdge(c,h,k,m,d,l);f=h.m_vertexCount;l=h.m_vertices;h=l[m];d=h.Copy();if(m+1<f){h=l[parseInt(m+
1)];h=h.Copy()}else{h=l[0];h=h.Copy()}b2Math.SubtractVV(h,d);f=b2Math.b2MulMV(k.R,b2Math.SubtractVV(h,d));f.Normalize();m=b2Math.b2CrossVF(f,1);d=b2Math.b2MulX(k,d);h=b2Math.b2MulX(k,h);k=b2Math.b2Dot(m,d);l=-b2Math.b2Dot(f,d);h=b2Math.b2Dot(f,h);i=[new ClipVertex,new ClipVertex];d=[new ClipVertex,new ClipVertex];j=0;j=b2Collision.ClipSegmentToLine(i,c,f.Negative(),l);if(!(j<2)){j=b2Collision.ClipSegmentToLine(d,i,f,h);if(!(j<2)){a.normal=g?m.Negative():m.Copy();for(l=f=0;l<b2Settings.b2_maxManifoldPoints;++l){c=
d[l];h=b2Math.b2Dot(m,c.v)-k;if(h<=0){i=a.points[f];i.separation=h;i.localPoint1=b2Math.b2MulXT(b,c.v);i.localPoint2=b2Math.b2MulXT(e,c.v);i.id.key=c.id._key;i.id.features.flip=g;++f}}a.pointCount=f}}}}};
b2Collision.b2CollideCircles=function(a,c,b,d,e){a.pointCount=0;var f,g;f=b.R;g=c.m_localPosition;var h=b.position.x+(f.col1.x*g.x+f.col2.x*g.y),i=b.position.y+(f.col1.y*g.x+f.col2.y*g.y);f=e.R;g=d.m_localPosition;var j=e.position.x+(f.col1.x*g.x+f.col2.x*g.y);f=e.position.y+(f.col1.y*g.x+f.col2.y*g.y);g=j-h;var k=f-i,l=g*g+k*k;c=c.m_radius;d=d.m_radius;var m=c+d;if(!(l>m*m)){if(l<Number.MIN_VALUE){l=-m;a.normal.Set(0,1)}else{var n=Math.sqrt(l);l=n-m;m=1/n;a.normal.x=m*g;a.normal.y=m*k}a.pointCount=
1;g=a.points[0];g.id.key=0;g.separation=l;h+=c*a.normal.x;i+=c*a.normal.y;j-=d*a.normal.x;f-=d*a.normal.y;a=0.5*(h+j);i=0.5*(i+f);h=a-b.position.x;j=i-b.position.y;g.localPoint1.x=h*b.R.col1.x+j*b.R.col1.y;g.localPoint1.y=h*b.R.col2.x+j*b.R.col2.y;h=a-e.position.x;j=i-e.position.y;g.localPoint2.x=h*e.R.col1.x+j*e.R.col1.y;g.localPoint2.y=h*e.R.col2.x+j*e.R.col2.y}};
b2Collision.b2CollidePolygonAndCircle=function(a,c,b,d,e){a.pointCount=0;var f,g,h,i,j,k;k=e.R;j=d.m_localPosition;i=e.position.x+(k.col1.x*j.x+k.col2.x*j.y);var l=e.position.y+(k.col1.y*j.x+k.col2.y*j.y);g=i-b.position.x;h=l-b.position.y;k=b.R;var m=g*k.col1.x+h*k.col1.y;k=g*k.col2.x+h*k.col2.y;var n=0,o=-Number.MAX_VALUE;d=d.m_radius;var p=c.m_vertexCount;f=c.m_vertices;c=c.m_normals;for(var q=0;q<p;++q){j=f[q];g=m-j.x;h=k-j.y;j=c[q];g=j.x*g+j.y*h;if(g>d)return;if(g>o){o=g;n=q}}if(o<Number.MIN_VALUE){a.pointCount=
1;j=c[n];k=b.R;a.normal.x=k.col1.x*j.x+k.col2.x*j.y;a.normal.y=k.col1.y*j.x+k.col2.y*j.y;f=a.points[0];f.id.features.incidentEdge=n;f.id.features.incidentVertex=b2Collision.b2_nullFeature;f.id.features.referenceEdge=0;f.id.features.flip=0;i=i-d*a.normal.x;a=l-d*a.normal.y;g=i-b.position.x;h=a-b.position.y;k=b.R;f.localPoint1.x=g*k.col1.x+h*k.col1.y;f.localPoint1.y=g*k.col2.x+h*k.col2.y;g=i-e.position.x;h=a-e.position.y;k=e.R;f.localPoint2.x=g*k.col1.x+h*k.col1.y;f.localPoint2.y=g*k.col2.x+h*k.col2.y;
f.separation=o-d}else{o=n;p=o+1<p?o+1:0;j=f[o];c=f[p];var s=c.x-j.x;q=c.y-j.y;var w=Math.sqrt(s*s+q*q);s/=w;q/=w;g=m-j.x;h=k-j.y;g=g*s+h*q;f=a.points[0];if(g<=0){h=j.x;j=j.y;f.id.features.incidentEdge=b2Collision.b2_nullFeature;f.id.features.incidentVertex=o}else if(g>=w){h=c.x;j=c.y;f.id.features.incidentEdge=b2Collision.b2_nullFeature;f.id.features.incidentVertex=p}else{h=s*g+j.x;j=q*g+j.y;f.id.features.incidentEdge=n;f.id.features.incidentVertex=b2Collision.b2_nullFeature}g=m-h;h=k-j;m=Math.sqrt(g*
g+h*h);g/=m;h/=m;if(!(m>d)){a.pointCount=1;k=b.R;a.normal.x=k.col1.x*g+k.col2.x*h;a.normal.y=k.col1.y*g+k.col2.y*h;i=i-d*a.normal.x;a=l-d*a.normal.y;g=i-b.position.x;h=a-b.position.y;k=b.R;f.localPoint1.x=g*k.col1.x+h*k.col1.y;f.localPoint1.y=g*k.col2.x+h*k.col2.y;g=i-e.position.x;h=a-e.position.y;k=e.R;f.localPoint2.x=g*k.col1.x+h*k.col1.y;f.localPoint2.y=g*k.col2.x+h*k.col2.y;f.separation=m-d;f.id.features.referenceEdge=0;f.id.features.flip=0}}};
b2Collision.b2TestOverlap=function(a,c){var b=c.lowerBound,d=a.upperBound,e=b.x-d.x,f=b.y-d.y;b=a.lowerBound;d=c.upperBound;var g=b.y-d.y;if(e>0||f>0)return false;if(b.x-d.x>0||g>0)return false;return true};var b2Mat22=function(){this.__varz();this.__constructor.apply(this,arguments)};b2Mat22.prototype.__constructor=function(a,c,b){if(c!=null&&b!=null){this.col1.SetV(c);this.col2.SetV(b)}else{c=Math.cos(a);a=Math.sin(a);this.col1.x=c;this.col2.x=-a;this.col1.y=a;this.col2.y=c}};b2Mat22.prototype.__varz=function(){this.col1=new b2Vec2;this.col2=new b2Vec2};b2Mat22.prototype.col1=new b2Vec2;b2Mat22.prototype.col2=new b2Vec2;
...
b2Mat22.prototype.Solve=function(a,c,b){var d=this.col1.x,e=this.col2.x,f=this.col1.y,g=this.col2.y,h=d*g-e*f;h=1/h;a.x=h*(g*c-e*b);a.y=h*(d*b-f*c);return a};b2Mat22.prototype.Abs=function(){this.col1.Abs();this.col2.Abs()};var b2BoundaryListener=function(){this.__varz();this.__constructor.apply(this,arguments)};b2BoundaryListener.prototype.__constructor=function(){};b2BoundaryListener.prototype.__varz=function(){};b2BoundaryListener.prototype.Violation=function(){};var b2PairManager=function(){this.__varz();this.__constructor.apply(this,arguments)};
...
b2PairManager.prototype.AddPair=function(a,c){if(a>c){var b=a;a=c;c=b}b=b2PairManager.Hash(a,c)&b2Pair.b2_tableMask;var d=d=this.FindHash(a,c,b);if(d!=null)return d;var e=this.m_freePair;d=this.m_pairs[e];this.m_freePair=d.next;d.proxyId1=a;d.proxyId2=c;d.status=0;d.userData=null;d.next=this.m_hashTable[b];this.m_hashTable[b]=e;++this.m_pairCount;return d};
b2PairManager.prototype.RemovePair=function(a,c){var b;if(a>c){var d=a;a=c;c=d}var e=b2PairManager.Hash(a,c)&b2Pair.b2_tableMask;b=this.m_hashTable[e];for(var f=null;b!=b2Pair.b2_nullPair;)if(b2PairManager.Equals(this.m_pairs[b],a,c)){d=b;b=this.m_pairs[b];if(f)f.next=b.next;else this.m_hashTable[e]=b.next;b=this.m_pairs[d];e=b.userData;b.next=this.m_freePair;b.proxyId1=b2Pair.b2_nullProxy;b.proxyId2=b2Pair.b2_nullProxy;b.userData=null;b.status=0;this.m_freePair=d;--this.m_pairCount;return e}else{f=
this.m_pairs[b];b=f.next}return null};b2PairManager.prototype.Find=function(a,c){if(a>c){var b=a;a=c;c=b}b=b2PairManager.Hash(a,c)&b2Pair.b2_tableMask;return this.FindHash(a,c,b)};b2PairManager.prototype.FindHash=function(a,c,b){var d=this.m_hashTable[b];for(b=this.m_pairs[d];d!=b2Pair.b2_nullPair&&b2PairManager.Equals(b,a,c)==false;){d=b.next;b=this.m_pairs[d]}if(d==b2Pair.b2_nullPair)return null;return b};b2PairManager.prototype.ValidateBuffer=function(){};
b2PairManager.prototype.ValidateTable=function(){};b2PairManager.prototype.Initialize=function(a,c){this.m_broadPhase=a;this.m_callback=c};b2PairManager.prototype.AddBufferedPair=function(a,c){var b,d=this.AddPair(a,c);if(d.IsBuffered()==false){d.SetBuffered();b=this.m_pairBuffer[this.m_pairBufferCount];b.proxyId1=d.proxyId1;b.proxyId2=d.proxyId2;++this.m_pairBufferCount}d.ClearRemoved();b2BroadPhase.s_validate&&this.ValidateBuffer()};
b2PairManager.prototype.RemoveBufferedPair=function(a,c){var b,d=this.Find(a,c);if(d!=null){if(d.IsBuffered()==false){d.SetBuffered();b=this.m_pairBuffer[this.m_pairBufferCount];b.proxyId1=d.proxyId1;b.proxyId2=d.proxyId2;++this.m_pairBufferCount}d.SetRemoved();b2BroadPhase.s_validate&&this.ValidateBuffer()}};
b2PairManager.prototype.Commit=function(){var a,c=0,b=0,d=this.m_broadPhase.m_proxyPool;for(c=0;c<this.m_pairBufferCount;++c){a=this.m_pairBuffer[c];var e=this.Find(a.proxyId1,a.proxyId2);e.ClearBuffered();a=d[e.proxyId1];var f=d[e.proxyId2];if(e.IsRemoved()){e.IsFinal()==true&&this.m_callback.PairRemoved(a.userData,f.userData,e.userData);a=this.m_pairBuffer[b];a.proxyId1=e.proxyId1;a.proxyId2=e.proxyId2;++b}else if(e.IsFinal()==false){e.userData=this.m_callback.PairAdded(a.userData,f.userData);e.SetFinal()}}for(c=
0;c<b;++c){a=this.m_pairBuffer[c];this.RemovePair(a.proxyId1,a.proxyId2)}this.m_pairBufferCount=0;b2BroadPhase.s_validate&&this.ValidateTable()};var b2BoundValues=function(){this.__varz();this.__constructor.apply(this,arguments)};b2BoundValues.prototype.__constructor=function(){};b2BoundValues.prototype.__varz=function(){this.lowerValues=[0,0];this.upperValues=[0,0]};b2BoundValues.prototype.lowerValues=[0,0];b2BoundValues.prototype.upperValues=[0,0];var Features=function(){this.__varz();this.__constructor.apply(this,arguments)};Features.prototype.__constructor=function(){};Features.prototype.__varz=function(){};Features.prototype._referenceEdge=0;Features.prototype._incidentEdge=0;Features.prototype._incidentVertex=0;Features.prototype._flip=0;Features.prototype._m_id=null;Features.prototype.__defineSetter__("referenceEdge",function(a){this._referenceEdge=a;this._m_id._key=this._m_id._key&4294967040|this._referenceEdge&255});
Features.prototype.__defineGetter__("referenceEdge",function(){return this._referenceEdge});Features.prototype.__defineSetter__("incidentEdge",function(a){this._incidentEdge=a;this._m_id._key=this._m_id._key&4294902015|this._incidentEdge<<8&65280});Features.prototype.__defineGetter__("incidentEdge",function(){return this._incidentEdge});Features.prototype.__defineSetter__("incidentVertex",function(a){this._incidentVertex=a;this._m_id._key=this._m_id._key&4278255615|this._incidentVertex<<16&16711680});
Features.prototype.__defineGetter__("incidentVertex",function(){return this._incidentVertex});Features.prototype.__defineSetter__("flip",function(a){this._flip=a;this._m_id._key=this._m_id._key&16777215|this._flip<<24&4278190080});Features.prototype.__defineGetter__("flip",function(){return this._flip});var b2XForm=function(){this.__varz();this.__constructor.apply(this,arguments)};b2XForm.prototype.__constructor=function(a,c){if(a){this.position.SetV(a);this.R.SetM(c)}};b2XForm.prototype.__varz=function(){this.position=new b2Vec2;this.R=new b2Mat22};b2XForm.prototype.position=new b2Vec2;b2XForm.prototype.R=new b2Mat22;b2XForm.prototype.Initialize=function(a,c){this.position.SetV(a);this.R.SetM(c)};b2XForm.prototype.SetIdentity=function(){this.position.SetZero();this.R.SetIdentity()};
b2XForm.prototype.Set=function(a){this.position.SetV(a.position);this.R.SetM(a.R)};var b2Shape=function(){this.__varz();this.__constructor.apply(this,arguments)};b2Shape.prototype.__constructor=function(a){this.m_userData=a.userData;this.m_friction=a.friction;this.m_restitution=a.restitution;this.m_density=a.density;this.m_body=null;this.m_sweepRadius=0;this.m_next=null;this.m_proxyId=b2Pair.b2_nullProxy;this.m_filter=a.filter.Copy();this.m_isSensor=a.isSensor};b2Shape.prototype.__varz=function(){};b2Shape.e_unknownShape=-1;b2Shape.e_circleShape=0;b2Shape.e_polygonShape=1;
...
b2Shape.prototype.GetNext=function(){return this.m_next};b2Shape.prototype.GetUserData=function(){return this.m_userData};b2Shape.prototype.SetUserData=function(a){this.m_userData=a};b2Shape.prototype.TestPoint=function(){return false};b2Shape.prototype.TestSegment=function(){return false};b2Shape.prototype.ComputeAABB=function(){};b2Shape.prototype.ComputeSweptAABB=function(){};b2Shape.prototype.ComputeMass=function(){};b2Shape.prototype.GetSweepRadius=function(){return this.m_sweepRadius};
...
b2Sweep.prototype.Advance=function(a){if(this.t0<a&&1-this.t0>Number.MIN_VALUE){var c=(a-this.t0)/(1-this.t0);this.c0.x=(1-c)*this.c0.x+c*this.c.x;this.c0.y=(1-c)*this.c0.y+c*this.c.y;this.a0=(1-c)*this.a0+c*this.a;this.t0=a}};var b2OBB=function(){this.__varz();this.__constructor.apply(this,arguments)};b2OBB.prototype.__constructor=function(){};b2OBB.prototype.__varz=function(){this.R=new b2Mat22;this.center=new b2Vec2;this.extents=new b2Vec2};b2OBB.prototype.R=new b2Mat22;b2OBB.prototype.center=new b2Vec2;b2OBB.prototype.extents=new b2Vec2;var b2Distance=function(){this.__varz();this.__constructor.apply(this,arguments)};b2Distance.prototype.__constructor=function(){};b2Distance.prototype.__varz=function(){};b2Distance.g_GJK_Iterations=0;b2Distance.s_p1s=[new b2Vec2,new b2Vec2,new b2Vec2];b2Distance.s_p2s=[new b2Vec2,new b2Vec2,new b2Vec2];b2Distance.s_points=[new b2Vec2,new b2Vec2,new b2Vec2];b2Distance.gPoint=new b2Point;
b2Distance.ProcessTwo=function(a,c,b,d,e){var f=e[0];e=e[1];var g=b[0];b=b[1];var h=d[0];d=d[1];var i=-e.x,j=-e.y,k=f.x-e.x,l=f.y-e.y,m=Math.sqrt(k*k+l*l);k/=m;l/=m;i=i*k+j*l;if(i<=0||m<Number.MIN_VALUE){a.SetV(b);c.SetV(d);g.SetV(b);h.SetV(d);f.SetV(e);return 1}i/=m;a.x=b.x+i*(g.x-b.x);a.y=b.y+i*(g.y-b.y);c.x=d.x+i*(h.x-d.x);c.y=d.y+i*(h.y-d.y);return 2};
b2Distance.ProcessThree=function(a,c,b,d,e){var f=e[0],g=e[1],h=e[2];e=b[0];var i=b[1];b=b[2];var j=d[0],k=d[1];d=d[2];var l=f.x,m=f.y,n=g.x,o=g.y,p=h.x,q=h.y,s=n-l,w=o-m,x=p-l,t=q-m,u=p-n,y=q-o,r=-(l*x+m*t),v=p*x+q*t,z=-(n*u+o*y);u=p*u+q*y;if(v<=0&&u<=0){a.SetV(b);c.SetV(d);e.SetV(b);j.SetV(d);f.SetV(h);return 1}w=s*t-w*x;s=w*(l*o-m*n);n=w*(n*q-o*p);if(n<=0&&z>=0&&u>=0&&z+u>0){r=z/(z+u);a.x=i.x+r*(b.x-i.x);a.y=i.y+r*(b.y-i.y);c.x=k.x+r*(d.x-k.x);c.y=k.y+r*(d.y-k.y);e.SetV(b);j.SetV(d);f.SetV(h);
return 2}f=w*(p*m-q*l);if(f<=0&&r>=0&&v>=0&&r+v>0){r=r/(r+v);a.x=e.x+r*(b.x-e.x);a.y=e.y+r*(b.y-e.y);c.x=j.x+r*(d.x-j.x);c.y=j.y+r*(d.y-j.y);i.SetV(b);k.SetV(d);g.SetV(h);return 2}h=n+f+s;h=1/h;g=n*h;f=f*h;h=1-g-f;a.x=g*e.x+f*i.x+h*b.x;a.y=g*e.y+f*i.y+h*b.y;c.x=g*j.x+f*k.x+h*d.x;c.y=g*j.y+f*k.y+h*d.y;return 3};
b2Distance.InPoints=function(a,c,b){for(var d=100*Number.MIN_VALUE,e=0;e<b;++e){var f=c[e],g=Math.abs(a.y-f.y),h=Math.max(Math.abs(a.y),Math.abs(f.y));if(Math.abs(a.x-f.x)<d*(Math.max(Math.abs(a.x),Math.abs(f.x))+1)&&g<d*(h+1))return true}return false};
b2Distance.DistanceGeneric=function(a,c,b,d,e,f){var g,h=b2Distance.s_p1s,i=b2Distance.s_p2s,j=b2Distance.s_points,k=0;a.SetV(b.GetFirstVertex(d));c.SetV(e.GetFirstVertex(f));for(var l=0,m=0;m<20;++m){g=c.x-a.x;var n=c.y-a.y,o=b.Support(d,g,n),p=e.Support(f,-g,-n);l=g*g+n*n;var q=p.x-o.x,s=p.y-o.y;if(l-(g*q+n*s)<=0.01*l){if(k==0){a.SetV(o);c.SetV(p)}b2Distance.g_GJK_Iterations=m;return Math.sqrt(l)}switch(k){case 0:g=h[0];g.SetV(o);g=i[0];g.SetV(p);g=j[0];g.x=q;g.y=s;a.SetV(h[0]);c.SetV(i[0]);++k;
break;case 1:g=h[1];g.SetV(o);g=i[1];g.SetV(p);g=j[1];g.x=q;g.y=s;k=b2Distance.ProcessTwo(a,c,h,i,j);break;case 2:g=h[2];g.SetV(o);g=i[2];g.SetV(p);g=j[2];g.x=q;g.y=s;k=b2Distance.ProcessThree(a,c,h,i,j)}if(k==3){b2Distance.g_GJK_Iterations=m;return 0}o=-Number.MAX_VALUE;for(p=0;p<k;++p){g=j[p];o=b2Math.b2Max(o,g.x*g.x+g.y*g.y)}if(k==3||l<=100*Number.MIN_VALUE*o){b2Distance.g_GJK_Iterations=m;g=c.x-a.x;n=c.y-a.y;l=g*g+n*n;return Math.sqrt(l)}}b2Distance.g_GJK_Iterations=20;return Math.sqrt(l)};
b2Distance.DistanceCC=function(a,c,b,d,e,f){var g,h;g=d.R;h=b.m_localPosition;var i=d.position.x+(g.col1.x*h.x+g.col2.x*h.y);d=d.position.y+(g.col1.y*h.x+g.col2.y*h.y);g=f.R;h=e.m_localPosition;var j=f.position.x+(g.col1.x*h.x+g.col2.x*h.y);f=f.position.y+(g.col1.y*h.x+g.col2.y*h.y);g=j-i;h=f-d;var k=g*g+h*h;b=b.m_radius-b2Settings.b2_toiSlop;e=e.m_radius-b2Settings.b2_toiSlop;var l=b+e;if(k>l*l){k=Math.sqrt(k);g/=k;h/=k;k=k-l;a.x=i+b*g;a.y=d+b*h;c.x=j-e*g;c.y=f-e*h;return k}else if(k>Number.MIN_VALUE*
Number.MIN_VALUE){k=Math.sqrt(k);g/=k;h/=k;a.x=i+b*g;a.y=d+b*h;c.x=a.x;c.y=a.y;return 0}a.x=i;a.y=d;c.x=a.x;c.y=a.y;return 0};
b2Distance.DistancePC=function(a,c,b,d,e,f){var g,h,i=b2Distance.gPoint;h=e.m_localPosition;g=f.R;i.p.x=f.position.x+(g.col1.x*h.x+g.col2.x*h.y);i.p.y=f.position.y+(g.col1.y*h.x+g.col2.y*h.y);b=b2Distance.DistanceGeneric(a,c,b,d,i,b2Math.b2XForm_identity);e=e.m_radius-b2Settings.b2_toiSlop;if(b>e){b-=e;d=c.x-a.x;a=c.y-a.y;f=Math.sqrt(d*d+a*a);d/=f;a/=f;c.x-=e*d;c.y-=e*a}else{b=0;c.x=a.x;c.y=a.y}return b};
b2Distance.Distance=function(a,c,b,d,e,f){var g=b.m_type,h=e.m_type;if(g==b2Shape.e_circleShape&&h==b2Shape.e_circleShape)return b2Distance.DistanceCC(a,c,b,d,e,f);if(g==b2Shape.e_polygonShape&&h==b2Shape.e_circleShape)return b2Distance.DistancePC(a,c,b,d,e,f);if(g==b2Shape.e_circleShape&&h==b2Shape.e_polygonShape)return b2Distance.DistancePC(c,a,e,f,b,d);if(g==b2Shape.e_polygonShape&&h==b2Shape.e_polygonShape)return b2Distance.DistanceGeneric(a,c,b,d,e,f);return 0};var b2Math=function(){this.__varz();this.__constructor.apply(this,arguments)};b2Math.prototype.__constructor=function(){};b2Math.prototype.__varz=function(){};b2Math.b2Vec2_zero=new b2Vec2(0,0);b2Math.b2Mat22_identity=new b2Mat22(0,new b2Vec2(1,0),new b2Vec2(0,1));b2Math.b2XForm_identity=new b2XForm(b2Math.b2Vec2_zero,b2Math.b2Mat22_identity);b2Math.b2IsValid=function(a){return isFinite(a)};b2Math.b2Dot=function(a,c){return a.x*c.x+a.y*c.y};b2Math.b2CrossVV=function(a,c){return a.x*c.y-a.y*c.x};
...
b2Math.b2Clamp=function(a,c,b){return b2Math.b2Max(c,b2Math.b2Min(a,b))};b2Math.b2ClampV=function(a,c,b){return b2Math.b2MaxV(c,b2Math.b2MinV(a,b))};b2Math.b2Swap=function(a,c){var b=a[0];a[0]=c[0];c[0]=b};b2Math.b2Random=function(){return Math.random()*2-1};b2Math.b2RandomRange=function(a,c){var b=Math.random();return b=(c-a)*b+a};b2Math.b2NextPowerOfTwo=function(a){a|=a>>1&2147483647;a|=a>>2&1073741823;a|=a>>4&268435455;a|=a>>8&16777215;a|=a>>16&65535;return a+1};
b2Math.b2IsPowerOfTwo=function(a){return a>0&&(a&a-1)==0};var b2Body=function(){this.__varz();this.__constructor.apply(this,arguments)};
b2Body.prototype.__constructor=function(a,c){this.m_flags=0;if(a.isBullet)this.m_flags|=b2Body.e_bulletFlag;if(a.fixedRotation)this.m_flags|=b2Body.e_fixedRotationFlag;if(a.allowSleep)this.m_flags|=b2Body.e_allowSleepFlag;if(a.isSleeping)this.m_flags|=b2Body.e_sleepFlag;this.m_world=c;this.m_xf.position.SetV(a.position);this.m_xf.R.Set(a.angle);this.m_sweep.localCenter.SetV(a.massData.center);this.m_sweep.t0=1;this.m_sweep.a0=this.m_sweep.a=a.angle;var b=this.m_xf.R,d=this.m_sweep.localCenter;this.m_sweep.c.x=
...
b2Body.prototype.CreateShape=function(a){if(this.m_world.m_lock==true)return null;a=b2Shape.Create(a,this.m_world.m_blockAllocator);a.m_next=this.m_shapeList;this.m_shapeList=a;++this.m_shapeCount;a.m_body=this;a.CreateProxy(this.m_world.m_broadPhase,this.m_xf);a.UpdateSweepRadius(this.m_sweep.localCenter);return a};
b2Body.prototype.DestroyShape=function(a){if(this.m_world.m_lock!=true){a.DestroyProxy(this.m_world.m_broadPhase);for(var c=this.m_shapeList,b=null;c!=null;){if(c==a){if(b)b.m_next=a.m_next;else this.m_shapeList=a.m_next;break}b=c;c=c.m_next}a.m_body=null;a.m_next=null;--this.m_shapeCount;b2Shape.Destroy(a,this.m_world.m_blockAllocator)}};
b2Body.prototype.SetMass=function(a){if(this.m_world.m_lock!=true){this.m_invI=this.m_I=this.m_invMass=0;this.m_mass=a.mass;if(this.m_mass>0)this.m_invMass=1/this.m_mass;if((this.m_flags&b2Body.e_fixedRotationFlag)==0)this.m_I=a.I;if(this.m_I>0)this.m_invI=1/this.m_I;this.m_sweep.localCenter.SetV(a.center);a=this.m_xf.R;var c=this.m_sweep.localCenter;this.m_sweep.c.x=a.col1.x*c.x+a.col2.x*c.y;this.m_sweep.c.y=a.col1.y*c.x+a.col2.y*c.y;this.m_sweep.c.x+=this.m_xf.position.x;this.m_sweep.c.y+=this.m_xf.position.y;
...
b2Body.prototype.SetBullet=function(a){if(a)this.m_flags|=b2Body.e_bulletFlag;else this.m_flags&=~b2Body.e_bulletFlag};b2Body.prototype.IsStatic=function(){return this.m_type==b2Body.e_staticType};b2Body.prototype.IsDynamic=function(){return this.m_type==b2Body.e_dynamicType};b2Body.prototype.IsFrozen=function(){return(this.m_flags&b2Body.e_frozenFlag)==b2Body.e_frozenFlag};b2Body.prototype.IsSleeping=function(){return(this.m_flags&b2Body.e_sleepFlag)==b2Body.e_sleepFlag};
b2Body.prototype.AllowSleeping=function(a){if(a)this.m_flags|=b2Body.e_allowSleepFlag;else{this.m_flags&=~b2Body.e_allowSleepFlag;this.WakeUp()}};b2Body.prototype.WakeUp=function(){this.m_flags&=~b2Body.e_sleepFlag;this.m_sleepTime=0};b2Body.prototype.PutToSleep=function(){this.m_flags|=b2Body.e_sleepFlag;this.m_sleepTime=0;this.m_linearVelocity.SetZero();this.m_angularVelocity=0;this.m_force.SetZero();this.m_torque=0};b2Body.prototype.GetShapeList=function(){return this.m_shapeList};
...
b2Body.prototype.SynchronizeShapes=function(){var a=b2Body.s_xf1;a.R.Set(this.m_sweep.a0);var c=a.R,b=this.m_sweep.localCenter;a.position.x=this.m_sweep.c0.x-(c.col1.x*b.x+c.col2.x*b.y);a.position.y=this.m_sweep.c0.y-(c.col1.y*b.x+c.col2.y*b.y);b=true;for(c=this.m_shapeList;c;c=c.m_next){b=c.Synchronize(this.m_world.m_broadPhase,a,this.m_xf);if(b==false)break}if(b==false){this.m_flags|=b2Body.e_frozenFlag;this.m_linearVelocity.SetZero();this.m_angularVelocity=0;for(c=this.m_shapeList;c;c=c.m_next)c.DestroyProxy(this.m_world.m_broadPhase);
return false}return true};b2Body.prototype.SynchronizeTransform=function(){this.m_xf.R.Set(this.m_sweep.a);var a=this.m_xf.R,c=this.m_sweep.localCenter;this.m_xf.position.x=this.m_sweep.c.x-(a.col1.x*c.x+a.col2.x*c.y);this.m_xf.position.y=this.m_sweep.c.y-(a.col1.y*c.x+a.col2.y*c.y)};b2Body.prototype.IsConnected=function(a){for(var c=this.m_jointList;c;c=c.next)if(c.other==a)return c.joint.m_collideConnected==false;return false};
b2Body.prototype.Advance=function(a){this.m_sweep.Advance(a);this.m_sweep.c.SetV(this.m_sweep.c0);this.m_sweep.a=this.m_sweep.a0;this.SynchronizeTransform()};var b2BodyDef=function(){this.__varz();this.__constructor.apply(this,arguments)};b2BodyDef.prototype.__constructor=function(){this.massData.center.SetZero();this.massData.mass=0;this.massData.I=0;this.userData=null;this.position.Set(0,0);this.angularDamping=this.linearDamping=this.angle=0;this.allowSleep=true;this.isBullet=this.fixedRotation=this.isSleeping=false};b2BodyDef.prototype.__varz=function(){this.massData=new b2MassData;this.position=new b2Vec2};b2BodyDef.prototype.massData=new b2MassData;
b2BodyDef.prototype.userData=null;b2BodyDef.prototype.position=new b2Vec2;b2BodyDef.prototype.angle=null;b2BodyDef.prototype.linearDamping=null;b2BodyDef.prototype.angularDamping=null;b2BodyDef.prototype.allowSleep=null;b2BodyDef.prototype.isSleeping=null;b2BodyDef.prototype.fixedRotation=null;b2BodyDef.prototype.isBullet=null;var b2BroadPhase=function(){this.__varz();this.__constructor.apply(this,arguments)};
...
b2BroadPhase.prototype.TestOverlapValidate=function(a,c){for(var b=0;b<2;++b){var d=this.m_bounds[b],e=d[a.lowerBounds[b]],f=d[c.upperBounds[b]];if(e.value>f.value)return false;e=d[a.upperBounds[b]];f=d[c.lowerBounds[b]];if(e.value<f.value)return false}return true};
b2BroadPhase.prototype.Query=function(a,c,b,d,e,f,g){b=b2BroadPhase.BinarySearch(e,f,b);d=b2BroadPhase.BinarySearch(e,f,d);for(var h=b;h<d;++h){f=e[h];f.IsLower()&&this.IncrementOverlapCount(f.proxyId)}if(b>0){h=b-1;f=e[h];for(var i=f.stabbingCount;i;){f=e[h];if(f.IsLower())if(b<=this.m_proxyPool[f.proxyId].upperBounds[g]){this.IncrementOverlapCount(f.proxyId);--i}--h}}a[0]=b;c[0]=d};
b2BroadPhase.prototype.IncrementOverlapCount=function(a){var c=this.m_proxyPool[a];if(c.timeStamp<this.m_timeStamp){c.timeStamp=this.m_timeStamp;c.overlapCount=1}else{c.overlapCount=2;this.m_queryResults[this.m_queryResultCount]=a;++this.m_queryResultCount}};b2BroadPhase.prototype.IncrementTimeStamp=function(){if(this.m_timeStamp==b2Settings.USHRT_MAX){for(var a=0;a<b2Settings.b2_maxProxies;++a)this.m_proxyPool[a].timeStamp=0;this.m_timeStamp=1}else++this.m_timeStamp};
b2BroadPhase.prototype.InRange=function(a){var c,b,d,e;c=a.lowerBound.x;b=a.lowerBound.y;c-=this.m_worldAABB.upperBound.x;b-=this.m_worldAABB.upperBound.y;d=this.m_worldAABB.lowerBound.x;e=this.m_worldAABB.lowerBound.y;d-=a.upperBound.x;e-=a.upperBound.y;c=b2Math.b2Max(c,d);b=b2Math.b2Max(b,e);return b2Math.b2Max(c,b)<0};b2BroadPhase.prototype.GetProxy=function(a){var c=this.m_proxyPool[a];if(a==b2Pair.b2_nullProxy||c.IsValid()==false)return null;return c};
b2BroadPhase.prototype.CreateProxy=function(a,c){var b=0,d,e=this.m_freeProxy;d=this.m_proxyPool[e];this.m_freeProxy=d.GetNext();d.overlapCount=0;d.userData=c;d=2*this.m_proxyCount;var f=[],g=[];this.ComputeBounds(f,g,a);for(var h=0;h<2;++h){var i=this.m_bounds[h],j=0,k=0;j=[j];k=[k];this.Query(j,k,f[h],g[h],i,d,h);j=j[0];k=k[0];var l=[],m=0,n=d-k,o;for(m=0;m<n;m++){l[m]=new b2Bound;o=l[m];b=i[parseInt(k+m)];o.value=b.value;o.proxyId=b.proxyId;o.stabbingCount=b.stabbingCount}n=l.length;var p=k+2;
for(m=0;m<n;m++){b=l[m];o=i[parseInt(p+m)];o.value=b.value;o.proxyId=b.proxyId;o.stabbingCount=b.stabbingCount}l=[];n=k-j;for(m=0;m<n;m++){l[m]=new b2Bound;o=l[m];b=i[parseInt(j+m)];o.value=b.value;o.proxyId=b.proxyId;o.stabbingCount=b.stabbingCount}n=l.length;p=j+1;for(m=0;m<n;m++){b=l[m];o=i[parseInt(p+m)];o.value=b.value;o.proxyId=b.proxyId;o.stabbingCount=b.stabbingCount}++k;o=i[j];b=i[k];o.value=f[h];o.proxyId=e;b.value=g[h];b.proxyId=e;l=i[parseInt(j-1)];o.stabbingCount=j==0?0:l.stabbingCount;
l=i[parseInt(k-1)];b.stabbingCount=l.stabbingCount;for(b=j;b<k;++b){l=i[b];l.stabbingCount++}for(b=j;b<d+2;++b){o=i[b];j=this.m_proxyPool[o.proxyId];if(o.IsLower())j.lowerBounds[h]=b;else j.upperBounds[h]=b}}++this.m_proxyCount;for(d=0;d<this.m_queryResultCount;++d)this.m_pairManager.AddBufferedPair(e,this.m_queryResults[d]);this.m_pairManager.Commit();this.m_queryResultCount=0;this.IncrementTimeStamp();return e};
b2BroadPhase.prototype.DestroyProxy=function(a){for(var c,b,d=this.m_proxyPool[a],e=2*this.m_proxyCount,f=0;f<2;++f){var g=this.m_bounds[f],h=d.lowerBounds[f],i=d.upperBounds[f];c=g[h];var j=c.value;b=g[i];var k=b.value,l=[],m=0,n=i-h-1;for(m=0;m<n;m++){l[m]=new b2Bound;c=l[m];b=g[parseInt(h+1+m)];c.value=b.value;c.proxyId=b.proxyId;c.stabbingCount=b.stabbingCount}n=l.length;var o=h;for(m=0;m<n;m++){b=l[m];c=g[parseInt(o+m)];c.value=b.value;c.proxyId=b.proxyId;c.stabbingCount=b.stabbingCount}l=[];
n=e-i-1;for(m=0;m<n;m++){l[m]=new b2Bound;c=l[m];b=g[parseInt(i+1+m)];c.value=b.value;c.proxyId=b.proxyId;c.stabbingCount=b.stabbingCount}n=l.length;o=i-1;for(m=0;m<n;m++){b=l[m];c=g[parseInt(o+m)];c.value=b.value;c.proxyId=b.proxyId;c.stabbingCount=b.stabbingCount}n=e-2;for(b=h;b<n;++b){c=g[b];l=this.m_proxyPool[c.proxyId];if(c.IsLower())l.lowerBounds[f]=b;else l.upperBounds[f]=b}n=i-1;for(h=h;h<n;++h){c=g[h];c.stabbingCount--}this.Query([0],[0],j,k,g,e-2,f)}for(c=0;c<this.m_queryResultCount;++c)this.m_pairManager.RemoveBufferedPair(a,
...
b2BroadPhase.prototype.MoveProxy=function(a,c){var b,d,e=0,f=0,g,h;b=0;if(!(a==b2Pair.b2_nullProxy||b2Settings.b2_maxProxies<=a))if(c.IsValid()!=false){var i=2*this.m_proxyCount,j=this.m_proxyPool[a],k=new b2BoundValues;this.ComputeBounds(k.lowerValues,k.upperValues,c);var l=new b2BoundValues;for(e=0;e<2;++e){g=this.m_bounds[e][j.lowerBounds[e]];l.lowerValues[e]=g.value;g=this.m_bounds[e][j.upperBounds[e]];l.upperValues[e]=g.value}for(e=0;e<2;++e){var m=this.m_bounds[e],n=j.lowerBounds[e],o=j.upperBounds[e],
p=k.lowerValues[e],q=k.upperValues[e];g=m[n];var s=p-g.value;g.value=p;g=m[o];var w=q-g.value;g.value=q;if(s<0)for(f=n;f>0&&p<m[parseInt(f-1)].value;){g=m[f];h=m[parseInt(f-1)];b=h.proxyId;d=this.m_proxyPool[h.proxyId];h.stabbingCount++;if(h.IsUpper()==true){this.TestOverlap(k,d)&&this.m_pairManager.AddBufferedPair(a,b);b=d.upperBounds;d=b[e];d++;b[e]=d;g.stabbingCount++}else{b=d.lowerBounds;d=b[e];d++;b[e]=d;g.stabbingCount--}b=j.lowerBounds;d=b[e];d--;b[e]=d;g.Swap(h);--f}if(w>0)for(f=o;f<i-1&&
m[parseInt(f+1)].value<=q;){g=m[f];h=m[parseInt(f+1)];b=h.proxyId;d=this.m_proxyPool[b];h.stabbingCount++;if(h.IsLower()==true){this.TestOverlap(k,d)&&this.m_pairManager.AddBufferedPair(a,b);b=d.lowerBounds;d=b[e];d--;b[e]=d;g.stabbingCount++}else{b=d.upperBounds;d=b[e];d--;b[e]=d;g.stabbingCount--}b=j.upperBounds;d=b[e];d++;b[e]=d;g.Swap(h);f++}if(s>0)for(f=n;f<i-1&&m[parseInt(f+1)].value<=p;){g=m[f];h=m[parseInt(f+1)];b=h.proxyId;d=this.m_proxyPool[b];h.stabbingCount--;if(h.IsUpper()){this.TestOverlap(l,
d)&&this.m_pairManager.RemoveBufferedPair(a,b);b=d.upperBounds;d=b[e];d--;b[e]=d;g.stabbingCount--}else{b=d.lowerBounds;d=b[e];d--;b[e]=d;g.stabbingCount++}b=j.lowerBounds;d=b[e];d++;b[e]=d;g.Swap(h);f++}if(w<0)for(f=o;f>0&&q<m[parseInt(f-1)].value;){g=m[f];h=m[parseInt(f-1)];b=h.proxyId;d=this.m_proxyPool[b];h.stabbingCount--;if(h.IsLower()==true){this.TestOverlap(l,d)&&this.m_pairManager.RemoveBufferedPair(a,b);b=d.lowerBounds;d=b[e];d++;b[e]=d;g.stabbingCount--}else{b=d.upperBounds;d=b[e];d++;
b[e]=d;g.stabbingCount++}b=j.upperBounds;d=b[e];d--;b[e]=d;g.Swap(h);f--}}}};b2BroadPhase.prototype.Commit=function(){this.m_pairManager.Commit()};
b2BroadPhase.prototype.QueryAABB=function(a,c,b){var d=[],e=[];this.ComputeBounds(d,e,a);a=[0];var f=[0];this.Query(a,f,d[0],e[0],this.m_bounds[0],2*this.m_proxyCount,0);this.Query(a,f,d[1],e[1],this.m_bounds[1],2*this.m_proxyCount,1);for(e=d=0;e<this.m_queryResultCount&&d<b;++e,++d)c[e]=this.m_proxyPool[this.m_queryResults[e]].userData;this.m_queryResultCount=0;this.IncrementTimeStamp();return d};
b2BroadPhase.prototype.Validate=function(){for(var a=0;a<2;++a)for(var c=this.m_bounds[a],b=2*this.m_proxyCount,d=0,e=0;e<b;++e)if(c[e].IsLower()==true)d++;else d--};b2BroadPhase.prototype.TestOverlap=function(a,c){for(var b=0;b<2;++b){var d=this.m_bounds[b],e=d[c.upperBounds[b]];if(a.lowerValues[b]>e.value)return false;e=d[c.lowerBounds[b]];if(a.upperValues[b]<e.value)return false}return true};var b2ContactID=function(){this.__varz();this.__constructor.apply(this,arguments)};b2ContactID.prototype.__constructor=function(){this.features._m_id=this};b2ContactID.prototype.__varz=function(){this.features=new Features};b2ContactID.prototype.features=new Features;b2ContactID.prototype._key=0;b2ContactID.prototype.Set=function(a){key=a._key};b2ContactID.prototype.Copy=function(){var a=new b2ContactID;a.key=key;return a};b2ContactID.prototype.__defineSetter__("key",function(){return this._key});
b2ContactID.prototype.__defineSetter__("key",function(a){this._key=a;this.features._referenceEdge=this._key&255;this.features._incidentEdge=(this._key&65280)>>8&255;this.features._incidentVertex=(this._key&16711680)>>16&255;this.features._flip=(this._key&4278190080)>>24&255});var b2TimeOfImpact=function(){this.__varz();this.__constructor.apply(this,arguments)};b2TimeOfImpact.prototype.__constructor=function(){};b2TimeOfImpact.prototype.__varz=function(){};b2TimeOfImpact.s_p1=new b2Vec2;b2TimeOfImpact.s_p2=new b2Vec2;b2TimeOfImpact.s_xf1=new b2XForm;b2TimeOfImpact.s_xf2=new b2XForm;
b2TimeOfImpact.TimeOfImpact=function(a,c,b,d){var e,f,g=a.m_sweepRadius,h=b.m_sweepRadius,i=c.t0,j=c.c.x-c.c0.x,k=c.c.y-c.c0.y,l=d.c.x-d.c0.x,m=d.c.y-d.c0.y,n=c.a-c.a0,o=d.a-d.a0,p=0,q=b2TimeOfImpact.s_p1,s=b2TimeOfImpact.s_p2,w=0,x=f=0,t=0;for(e=0;;){t=(1-p)*i+p;f=b2TimeOfImpact.s_xf1;x=b2TimeOfImpact.s_xf2;c.GetXForm(f,t);d.GetXForm(x,t);t=b2Distance.Distance(q,s,a,f,b,x);if(w==0)if(t>2*b2Settings.b2_toiSlop)e=1.5*b2Settings.b2_toiSlop;else{e=0.05*b2Settings.b2_toiSlop;f=t-0.5*b2Settings.b2_toiSlop;
e=e>f?e:f}if(t-e<0.05*b2Settings.b2_toiSlop||w==20)break;f=s.x-q.x;x=s.y-q.y;var u=Math.sqrt(f*f+x*x);f/=u;x/=u;f=f*(j-l)+x*(k-m)+(n<0?-n:n)*g+(o<0?-o:o)*h;if(f==0){p=1;break}t=p+(t-e)/f;if(t<0||1<t){p=1;break}if(t<(1+100*Number.MIN_VALUE)*p)break;p=t;++w}return p};var b2Joint=function(){this.__varz();this.__constructor.apply(this,arguments)};b2Joint.prototype.__constructor=function(a){this.m_type=a.type;this.m_next=this.m_prev=null;this.m_body1=a.body1;this.m_body2=a.body2;this.m_collideConnected=a.collideConnected;this.m_islandFlag=false;this.m_userData=a.userData};b2Joint.prototype.__varz=function(){this.m_node1=new b2JointEdge;this.m_node2=new b2JointEdge};b2Joint.e_unknownJoint=0;b2Joint.e_revoluteJoint=1;b2Joint.e_prismaticJoint=2;
...
b2PolygonDef.prototype.SetAsOrientedBox=function(a,c,b,d){this.vertexCount=4;this.vertices[0].Set(-a,-c);this.vertices[1].Set(a,-c);this.vertices[2].Set(a,c);this.vertices[3].Set(-a,c);if(b){c=b;var e=b2PolygonDef.s_mat;e.Set(d);for(d=0;d<this.vertexCount;++d){b=this.vertices[d];a=c.x+(e.col1.x*b.x+e.col2.x*b.y);b.y=c.y+(e.col1.y*b.x+e.col2.y*b.y);b.x=a}}};var b2PrismaticJointDef=function(){b2JointDef.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2PrismaticJointDef.prototype,b2JointDef.prototype);b2PrismaticJointDef.prototype._super=function(){b2JointDef.prototype.__constructor.apply(this,arguments)};
...
b2PulleyJoint.prototype.InitVelocityConstraints=function(a){var c=this.m_body1,b=this.m_body2,d;d=c.m_xf.R;var e=this.m_localAnchor1.x-c.m_sweep.localCenter.x,f=this.m_localAnchor1.y-c.m_sweep.localCenter.y,g=d.col1.x*e+d.col2.x*f;f=d.col1.y*e+d.col2.y*f;e=g;d=b.m_xf.R;var h=this.m_localAnchor2.x-b.m_sweep.localCenter.x,i=this.m_localAnchor2.y-b.m_sweep.localCenter.y;g=d.col1.x*h+d.col2.x*i;i=d.col1.y*h+d.col2.y*i;h=g;d=b.m_sweep.c.x+h;g=b.m_sweep.c.y+i;var j=this.m_ground.m_xf.position.x+this.m_groundAnchor2.x,
...
0}else{this.m_state=b2Joint.e_atUpperLimit;this.m_positionImpulse=0}if(d<this.m_maxLength1){this.m_limitState1=b2Joint.e_inactiveLimit;this.m_limitForce1=0}else{this.m_limitState1=b2Joint.e_atUpperLimit;this.m_limitPositionImpulse1=0}if(g<this.m_maxLength2){this.m_limitState2=b2Joint.e_inactiveLimit;this.m_limitForce2=0}else{this.m_limitState2=b2Joint.e_atUpperLimit;this.m_limitPositionImpulse2=0}d=e*this.m_u1.y-f*this.m_u1.x;g=h*this.m_u2.y-i*this.m_u2.x;this.m_limitMass1=c.m_invMass+c.m_invI*d*
d;this.m_limitMass2=b.m_invMass+b.m_invI*g*g;this.m_pulleyMass=this.m_limitMass1+this.m_ratio*this.m_ratio*this.m_limitMass2;this.m_limitMass1=1/this.m_limitMass1;this.m_limitMass2=1/this.m_limitMass2;this.m_pulleyMass=1/this.m_pulleyMass;if(a.warmStarting){d=a.dt*(-this.m_force-this.m_limitForce1)*this.m_u1.x;g=a.dt*(-this.m_force-this.m_limitForce1)*this.m_u1.y;j=a.dt*(-this.m_ratio*this.m_force-this.m_limitForce2)*this.m_u2.x;a=a.dt*(-this.m_ratio*this.m_force-this.m_limitForce2)*this.m_u2.y;c.m_linearVelocity.x+=
c.m_invMass*d;c.m_linearVelocity.y+=c.m_invMass*g;c.m_angularVelocity+=c.m_invI*(e*g-f*d);b.m_linearVelocity.x+=b.m_invMass*j;b.m_linearVelocity.y+=b.m_invMass*a;b.m_angularVelocity+=b.m_invI*(h*a-i*j)}else this.m_limitForce2=this.m_limitForce1=this.m_force=0};
b2PulleyJoint.prototype.SolveVelocityConstraints=function(a){var c=this.m_body1,b=this.m_body2,d;d=c.m_xf.R;var e=this.m_localAnchor1.x-c.m_sweep.localCenter.x,f=this.m_localAnchor1.y-c.m_sweep.localCenter.y,g=d.col1.x*e+d.col2.x*f;f=d.col1.y*e+d.col2.y*f;e=g;d=b.m_xf.R;var h=this.m_localAnchor2.x-b.m_sweep.localCenter.x,i=this.m_localAnchor2.y-b.m_sweep.localCenter.y;g=d.col1.x*h+d.col2.x*i;i=d.col1.y*h+d.col2.y*i;h=g;var j,k;if(this.m_state==b2Joint.e_atUpperLimit){d=c.m_linearVelocity.x+-c.m_angularVelocity*
...
g;c.m_angularVelocity+=c.m_invI*(e*g-f*d);b.m_linearVelocity.x+=b.m_invMass*j;b.m_linearVelocity.y+=b.m_invMass*k;b.m_angularVelocity+=b.m_invI*(h*k-i*j)}if(this.m_limitState1==b2Joint.e_atUpperLimit){d=c.m_linearVelocity.x+-c.m_angularVelocity*f;g=c.m_linearVelocity.y+c.m_angularVelocity*e;d=-(this.m_u1.x*d+this.m_u1.y*g);k=-a.inv_dt*this.m_limitMass1*d;d=this.m_limitForce1;this.m_limitForce1=b2Math.b2Max(0,this.m_limitForce1+k);k=this.m_limitForce1-d;d=-a.dt*k*this.m_u1.x;g=-a.dt*k*this.m_u1.y;
c.m_linearVelocity.x+=c.m_invMass*d;c.m_linearVelocity.y+=c.m_invMass*g;c.m_angularVelocity+=c.m_invI*(e*g-f*d)}if(this.m_limitState2==b2Joint.e_atUpperLimit){j=b.m_linearVelocity.x+-b.m_angularVelocity*i;k=b.m_linearVelocity.y+b.m_angularVelocity*h;d=-(this.m_u2.x*j+this.m_u2.y*k);k=-a.inv_dt*this.m_limitMass2*d;d=this.m_limitForce2;this.m_limitForce2=b2Math.b2Max(0,this.m_limitForce2+k);k=this.m_limitForce2-d;j=-a.dt*k*this.m_u2.x;k=-a.dt*k*this.m_u2.y;b.m_linearVelocity.x+=b.m_invMass*j;b.m_linearVelocity.y+=
b.m_invMass*k;b.m_angularVelocity+=b.m_invI*(h*k-i*j)}};
...
b-this.m_ratio*l;o=b2Math.b2Max(o,-b);b=b2Math.b2Clamp(b+b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);b=-this.m_pulleyMass*b;l=this.m_positionImpulse;this.m_positionImpulse=b2Math.b2Max(0,this.m_positionImpulse+b);b=this.m_positionImpulse-l;l=-b*this.m_u1.x;m=-b*this.m_u1.y;n=-this.m_ratio*b*this.m_u2.x;b=-this.m_ratio*b*this.m_u2.y;a.m_sweep.c.x+=a.m_invMass*l;a.m_sweep.c.y+=a.m_invMass*m;a.m_sweep.a+=a.m_invI*(h*m-i*l);c.m_sweep.c.x+=c.m_invMass*n;c.m_sweep.c.y+=c.m_invMass*b;
c.m_sweep.a+=c.m_invI*(j*b-k*n);a.SynchronizeTransform();c.SynchronizeTransform()}if(this.m_limitState1==b2Joint.e_atUpperLimit){b=a.m_xf.R;h=this.m_localAnchor1.x-a.m_sweep.localCenter.x;i=this.m_localAnchor1.y-a.m_sweep.localCenter.y;l=b.col1.x*h+b.col2.x*i;i=b.col1.y*h+b.col2.y*i;h=l;l=a.m_sweep.c.x+h;m=a.m_sweep.c.y+i;this.m_u1.Set(l-d,m-e);b=this.m_u1.Length();if(b>b2Settings.b2_linearSlop){this.m_u1.x*=1/b;this.m_u1.y*=1/b}else this.m_u1.SetZero();b=this.m_maxLength1-b;o=b2Math.b2Max(o,-b);
b=b2Math.b2Clamp(b+b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);b=-this.m_limitMass1*b;d=this.m_limitPositionImpulse1;this.m_limitPositionImpulse1=b2Math.b2Max(0,this.m_limitPositionImpulse1+b);b=this.m_limitPositionImpulse1-d;l=-b*this.m_u1.x;m=-b*this.m_u1.y;a.m_sweep.c.x+=a.m_invMass*l;a.m_sweep.c.y+=a.m_invMass*m;a.m_sweep.a+=a.m_invI*(h*m-i*l);a.SynchronizeTransform()}if(this.m_limitState2==b2Joint.e_atUpperLimit){b=c.m_xf.R;j=this.m_localAnchor2.x-c.m_sweep.localCenter.x;k=
this.m_localAnchor2.y-c.m_sweep.localCenter.y;l=b.col1.x*j+b.col2.x*k;k=b.col1.y*j+b.col2.y*k;j=l;n=c.m_sweep.c.x+j;b=c.m_sweep.c.y+k;this.m_u2.Set(n-f,b-g);l=this.m_u2.Length();if(l>b2Settings.b2_linearSlop){this.m_u2.x*=1/l;this.m_u2.y*=1/l}else this.m_u2.SetZero();b=this.m_maxLength2-l;o=b2Math.b2Max(o,-b);b=b2Math.b2Clamp(b+b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);b=-this.m_limitMass2*b;d=this.m_limitPositionImpulse2;this.m_limitPositionImpulse2=b2Math.b2Max(0,this.m_limitPositionImpulse2+
b);b=this.m_limitPositionImpulse2-d;n=-b*this.m_u2.x;b=-b*this.m_u2.y;c.m_sweep.c.x+=c.m_invMass*n;c.m_sweep.c.y+=c.m_invMass*b;c.m_sweep.a+=c.m_invI*(j*b-k*n);c.SynchronizeTransform()}return o<b2Settings.b2_linearSlop};var b2MouseJointDef=function(){b2JointDef.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2MouseJointDef.prototype,b2JointDef.prototype);b2MouseJointDef.prototype._super=function(){b2JointDef.prototype.__constructor.apply(this,arguments)};b2MouseJointDef.prototype.__constructor=function(){this.type=b2Joint.e_mouseJoint;this.maxForce=0;this.frequencyHz=5;this.dampingRatio=0.7;this.timeStep=1/60};b2MouseJointDef.prototype.__varz=function(){this.target=new b2Vec2};
b2MouseJointDef.prototype.target=new b2Vec2;b2MouseJointDef.prototype.maxForce=null;b2MouseJointDef.prototype.frequencyHz=null;b2MouseJointDef.prototype.dampingRatio=null;b2MouseJointDef.prototype.timeStep=null;var b2Contact=function(){this.__varz();this.__constructor.apply(this,arguments)};
...
b2Contact.AddType=function(a,c,b,d){b2Contact.s_registers[b][d].createFcn=a;b2Contact.s_registers[b][d].destroyFcn=c;b2Contact.s_registers[b][d].primary=true;if(b!=d){b2Contact.s_registers[d][b].createFcn=a;b2Contact.s_registers[d][b].destroyFcn=c;b2Contact.s_registers[d][b].primary=false}};
...
g;var j=b.m_linearVelocity.y+b.m_angularVelocity*h-c.m_linearVelocity.y-c.m_angularVelocity*f;d=-a.inv_dt*(this.m_pivotMass.col1.x*e+this.m_pivotMass.col2.x*j);e=-a.inv_dt*(this.m_pivotMass.col1.y*e+this.m_pivotMass.col2.y*j);this.m_pivotForce.x+=d;this.m_pivotForce.y+=e;d=a.dt*d;e=a.dt*e;c.m_linearVelocity.x-=c.m_invMass*d;c.m_linearVelocity.y-=c.m_invMass*e;c.m_angularVelocity-=c.m_invI*(f*e-g*d);b.m_linearVelocity.x+=b.m_invMass*d;b.m_linearVelocity.y+=b.m_invMass*e;b.m_angularVelocity+=b.m_invI*
...
b2RevoluteJoint.prototype.SolvePositionConstraints=function(){var a,c=this.m_body1,b=this.m_body2,d=0;d=c.m_xf.R;var e=this.m_localAnchor1.x-c.m_sweep.localCenter.x,f=this.m_localAnchor1.y-c.m_sweep.localCenter.y,g=d.col1.x*e+d.col2.x*f;f=d.col1.y*e+d.col2.y*f;e=g;d=b.m_xf.R;a=this.m_localAnchor2.x-b.m_sweep.localCenter.x;var h=this.m_localAnchor2.y-b.m_sweep.localCenter.y;g=d.col1.x*a+d.col2.x*h;h=d.col1.y*a+d.col2.y*h;a=g;g=b.m_sweep.c.x+a-(c.m_sweep.c.x+e);var i=b.m_sweep.c.y+h-(c.m_sweep.c.y+
f);d=Math.sqrt(g*g+i*i);var j=c.m_invMass,k=b.m_invMass,l=c.m_invI,m=b.m_invI;this.K1.col1.x=j+k;this.K1.col2.x=0;this.K1.col1.y=0;this.K1.col2.y=j+k;this.K2.col1.x=l*f*f;this.K2.col2.x=-l*e*f;this.K2.col1.y=-l*e*f;this.K2.col2.y=l*e*e;this.K3.col1.x=m*h*h;this.K3.col2.x=-m*a*h;this.K3.col1.y=-m*a*h;this.K3.col2.y=m*a*a;this.K.SetM(this.K1);this.K.AddM(this.K2);this.K.AddM(this.K3);this.K.Solve(b2RevoluteJoint.tImpulse,-g,-i);g=b2RevoluteJoint.tImpulse.x;i=b2RevoluteJoint.tImpulse.y;c.m_sweep.c.x-=
c.m_invMass*g;c.m_sweep.c.y-=c.m_invMass*i;c.m_sweep.a-=c.m_invI*(e*i-f*g);b.m_sweep.c.x+=b.m_invMass*g;b.m_sweep.c.y+=b.m_invMass*i;b.m_sweep.a+=b.m_invI*(a*i-h*g);c.SynchronizeTransform();b.SynchronizeTransform();e=0;if(this.m_enableLimit&&this.m_limitState!=b2Joint.e_inactiveLimit){a=b.m_sweep.a-c.m_sweep.a-this.m_referenceAngle;f=0;if(this.m_limitState==b2Joint.e_equalLimits){a=b2Math.b2Clamp(a,-b2Settings.b2_maxAngularCorrection,b2Settings.b2_maxAngularCorrection);f=-this.m_motorMass*a;e=b2Math.b2Abs(a)}else if(this.m_limitState==
b2Joint.e_atLowerLimit){a=a-this.m_lowerAngle;e=b2Math.b2Max(0,-a);a=b2Math.b2Clamp(a+b2Settings.b2_angularSlop,-b2Settings.b2_maxAngularCorrection,0);f=-this.m_motorMass*a;a=this.m_limitPositionImpulse;this.m_limitPositionImpulse=b2Math.b2Max(this.m_limitPositionImpulse+f,0);f=this.m_limitPositionImpulse-a}else if(this.m_limitState==b2Joint.e_atUpperLimit){a=a-this.m_upperAngle;e=b2Math.b2Max(0,a);a=b2Math.b2Clamp(a-b2Settings.b2_angularSlop,0,b2Settings.b2_maxAngularCorrection);f=-this.m_motorMass*
a;a=this.m_limitPositionImpulse;this.m_limitPositionImpulse=b2Math.b2Min(this.m_limitPositionImpulse+f,0);f=this.m_limitPositionImpulse-a}c.m_sweep.a-=c.m_invI*f;b.m_sweep.a+=b.m_invI*f;c.SynchronizeTransform();b.SynchronizeTransform()}return d<=b2Settings.b2_linearSlop&&e<=b2Settings.b2_angularSlop};var b2PolygonShape=function(){b2Shape.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2PolygonShape.prototype,b2Shape.prototype);b2PolygonShape.prototype._super=function(){b2Shape.prototype.__constructor.apply(this,arguments)};
b2PolygonShape.prototype.__constructor=function(a){this._super(a);this.m_type=b2Shape.e_polygonShape;this.m_vertexCount=a.vertexCount;var c=0,b=c,d=c;for(c=0;c<this.m_vertexCount;++c)this.m_vertices[c]=a.vertices[c].Copy();for(c=0;c<this.m_vertexCount;++c){b=c;d=c+1<this.m_vertexCount?c+1:0;var e=this.m_vertices[d].x-this.m_vertices[b].x;b=this.m_vertices[d].y-this.m_vertices[b].y;d=Math.sqrt(e*e+b*b);this.m_normals[c]=new b2Vec2(b/d,-e/d)}this.m_centroid=b2PolygonShape.ComputeCentroid(a.vertices,
a.vertexCount);b2PolygonShape.ComputeOBB(this.m_obb,this.m_vertices,this.m_vertexCount);for(c=0;c<this.m_vertexCount;++c){b=c-1>=0?c-1:this.m_vertexCount-1;d=c;a=this.m_normals[b].x;e=this.m_normals[b].y;b=this.m_normals[d].x;d=this.m_normals[d].y;var f=this.m_vertices[c].x-this.m_centroid.x,g=this.m_vertices[c].y-this.m_centroid.y,h=a*f+e*g-b2Settings.b2_toiSlop;f=b*f+d*g-b2Settings.b2_toiSlop;g=1/(a*d-e*b);this.m_coreVertices[c]=new b2Vec2(g*(d*h-e*f)+this.m_centroid.x,g*(a*f-b*h)+this.m_centroid.y)}};
...
b2PolygonShape.ComputeOBB=function(a,c,b){var d=0,e=Array(b2Settings.b2_maxPolygonVertices+1);for(d=0;d<b;++d)e[d]=c[d];e[b]=e[0];c=Number.MAX_VALUE;for(d=1;d<=b;++d){var f=e[parseInt(d-1)],g=e[d].x-f.x,h=e[d].y-f.y,i=Math.sqrt(g*g+h*h);g/=i;h/=i;for(var j=-h,k=g,l=i=Number.MAX_VALUE,m=-Number.MAX_VALUE,n=-Number.MAX_VALUE,o=0;o<b;++o){var p=e[o].x-f.x,q=e[o].y-f.y,s=g*p+h*q;p=j*p+k*q;if(s<i)i=s;if(p<l)l=p;if(s>m)m=s;if(p>n)n=p}o=(m-i)*(n-l);if(o<0.95*c){c=o;a.R.col1.x=g;a.R.col1.y=h;a.R.col2.x=j;
...
b2PolygonShape.prototype.m_vertexCount=0;b2PolygonShape.prototype.TestPoint=function(a,c){var b;b=a.R;for(var d=c.x-a.position.x,e=c.y-a.position.y,f=d*b.col1.x+e*b.col1.y,g=d*b.col2.x+e*b.col2.y,h=0;h<this.m_vertexCount;++h){b=this.m_vertices[h];d=f-b.x;e=g-b.y;b=this.m_normals[h];if(b.x*d+b.y*e>0)return false}return true};
b2PolygonShape.prototype.TestSegment=function(a,c,b,d,e){var f=0;e=e;var g,h,i,j;g=d.p1.x-a.position.x;h=d.p1.y-a.position.y;i=a.R;var k=g*i.col1.x+h*i.col1.y,l=g*i.col2.x+h*i.col2.y;g=d.p2.x-a.position.x;h=d.p2.y-a.position.y;i=a.R;d=g*i.col1.x+h*i.col1.y-k;i=g*i.col2.x+h*i.col2.y-l;for(var m=-1,n=0;n<this.m_vertexCount;++n){j=this.m_vertices[n];g=j.x-k;h=j.y-l;j=this.m_normals[n];g=j.x*g+j.y*h;h=j.x*d+j.y*i;if(h<0&&g<f*h){f=g/h;m=n}else if(h>0&&g<e*h)e=g/h;if(e<f)return false}if(m>=0){c[0]=f;i=
a.R;j=this.m_normals[m];b.x=i.col1.x*j.x+i.col2.x*j.y;b.y=i.col1.y*j.x+i.col2.y*j.y;return true}return false};
...
b2PolygonShape.prototype.ComputeMass=function(a){for(var c=0,b=0,d=0,e=0,f=1/3,g=0;g<this.m_vertexCount;++g){var h=this.m_vertices[g],i=g+1<this.m_vertexCount?this.m_vertices[parseInt(g+1)]:this.m_vertices[0],j=h.x-0,k=h.y-0,l=i.x-0,m=i.y-0,n=j*m-k*l,o=0.5*n;d+=o;c+=o*f*(0+h.x+i.x);b+=o*f*(0+h.y+i.y);h=j;k=k;l=l;m=m;e+=n*(f*(0.25*(h*h+l*h+l*l)+(0*h+0*l))+0+(f*(0.25*(k*k+m*k+m*m)+(0*k+0*m))+0))}a.mass=this.m_density*d;c*=1/d;b*=1/d;a.center.Set(c,b);a.I=this.m_density*e};
b2PolygonShape.prototype.GetOBB=function(){return this.m_obb};b2PolygonShape.prototype.GetCentroid=function(){return this.m_centroid};b2PolygonShape.prototype.GetVertexCount=function(){return this.m_vertexCount};b2PolygonShape.prototype.GetVertices=function(){return this.m_vertices};b2PolygonShape.prototype.GetCoreVertices=function(){return this.m_coreVertices};b2PolygonShape.prototype.GetNormals=function(){return this.m_normals};
b2PolygonShape.prototype.GetFirstVertex=function(a){return b2Math.b2MulX(a,this.m_coreVertices[0])};b2PolygonShape.prototype.Centroid=function(a){return b2Math.b2MulX(a,this.m_centroid)};
b2PolygonShape.prototype.Support=function(a,c,b){var d;d=a.R;var e=c*d.col1.x+b*d.col1.y;d=c*d.col2.x+b*d.col2.y;c=0;b=this.m_coreVertices[0];for(var f=b.x*e+b.y*d,g=1;g<this.m_vertexCount;++g){b=this.m_coreVertices[g];b=b.x*e+b.y*d;if(b>f){c=g;f=b}}d=a.R;b=this.m_coreVertices[c];this.s_supportVec.x=a.position.x+(d.col1.x*b.x+d.col2.x*b.y);this.s_supportVec.y=a.position.y+(d.col1.y*b.x+d.col2.y*b.y);return this.s_supportVec};
b2PolygonShape.prototype.UpdateSweepRadius=function(a){var c;for(var b=this.m_sweepRadius=0;b<this.m_vertexCount;++b){c=this.m_coreVertices[b];var d=c.x-a.x;c=c.y-a.y;d=Math.sqrt(d*d+c*c);if(d>this.m_sweepRadius)this.m_sweepRadius=d}};var b2DistanceJoint=function(){b2Joint.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2DistanceJoint.prototype,b2Joint.prototype);b2DistanceJoint.prototype._super=function(){b2Joint.prototype.__constructor.apply(this,arguments)};
...
e.m_sweep.c.y+i-d.m_sweep.c.y-g;b=Math.sqrt(this.m_u.x*this.m_u.x+this.m_u.y*this.m_u.y);b>b2Settings.b2_linearSlop?this.m_u.Multiply(1/b):this.m_u.SetZero();c=f*this.m_u.y-g*this.m_u.x;var j=h*this.m_u.y-i*this.m_u.x;c=d.m_invMass+d.m_invI*c*c+e.m_invMass+e.m_invI*j*j;this.m_mass=1/c;if(this.m_frequencyHz>0){b=b-this.m_length;j=2*Math.PI*this.m_frequencyHz;var k=this.m_mass*j*j;this.m_gamma=1/(a.dt*(2*this.m_mass*this.m_dampingRatio*j+a.dt*k));this.m_bias=b*a.dt*k*this.m_gamma;this.m_mass=1/(c+this.m_gamma)}if(a.warmStarting){this.m_impulse*=
a.dtRatio;a=this.m_impulse*this.m_u.x;c=this.m_impulse*this.m_u.y;d.m_linearVelocity.x-=d.m_invMass*a;d.m_linearVelocity.y-=d.m_invMass*c;d.m_angularVelocity-=d.m_invI*(f*c-g*a);e.m_linearVelocity.x+=e.m_invMass*a;e.m_linearVelocity.y+=e.m_invMass*c;e.m_angularVelocity+=e.m_invI*(h*c-i*a)}else this.m_impulse=0};
...
-c.m_angularVelocity*e))+this.m_u.y*(b.m_linearVelocity.y+b.m_angularVelocity*g-(c.m_linearVelocity.y+c.m_angularVelocity*d))+this.m_bias+this.m_gamma*this.m_impulse);this.m_impulse+=f;a=f*this.m_u.x;f=f*this.m_u.y;c.m_linearVelocity.x-=c.m_invMass*a;c.m_linearVelocity.y-=c.m_invMass*f;c.m_angularVelocity-=c.m_invI*(d*f-e*a);b.m_linearVelocity.x+=b.m_invMass*a;b.m_linearVelocity.y+=b.m_invMass*f;b.m_angularVelocity+=b.m_invI*(g*f-h*a)};
b2DistanceJoint.prototype.SolvePositionConstraints=function(){var a;if(this.m_frequencyHz>0)return true;var c=this.m_body1,b=this.m_body2;a=c.m_xf.R;var d=this.m_localAnchor1.x-c.m_sweep.localCenter.x,e=this.m_localAnchor1.y-c.m_sweep.localCenter.y,f=a.col1.x*d+a.col2.x*e;e=a.col1.y*d+a.col2.y*e;d=f;a=b.m_xf.R;var g=this.m_localAnchor2.x-b.m_sweep.localCenter.x,h=this.m_localAnchor2.y-b.m_sweep.localCenter.y;f=a.col1.x*g+a.col2.x*h;h=a.col1.y*g+a.col2.y*h;g=f;f=b.m_sweep.c.x+g-c.m_sweep.c.x-d;var i=
b.m_sweep.c.y+h-c.m_sweep.c.y-e;a=Math.sqrt(f*f+i*i);f/=a;i/=a;a=a-this.m_length;a=b2Math.b2Clamp(a,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);var j=-this.m_mass*a;this.m_u.Set(f,i);f=j*this.m_u.x;i=j*this.m_u.y;c.m_sweep.c.x-=c.m_invMass*f;c.m_sweep.c.y-=c.m_invMass*i;c.m_sweep.a-=c.m_invI*(d*i-e*f);b.m_sweep.c.x+=b.m_invMass*f;b.m_sweep.c.y+=b.m_invMass*i;b.m_sweep.a+=b.m_invI*(g*i-h*f);c.SynchronizeTransform();b.SynchronizeTransform();return b2Math.b2Abs(a)<b2Settings.b2_linearSlop};
...
b2ContactPoint.prototype.separation=null;b2ContactPoint.prototype.friction=null;b2ContactPoint.prototype.restitution=null;b2ContactPoint.prototype.id=new b2ContactID;var b2DistanceJointDef=function(){b2JointDef.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2DistanceJointDef.prototype,b2JointDef.prototype);b2DistanceJointDef.prototype._super=function(){b2JointDef.prototype.__constructor.apply(this,arguments)};b2DistanceJointDef.prototype.__constructor=function(){this.type=b2Joint.e_distanceJoint;this.length=1;this.dampingRatio=this.frequencyHz=0};
...
b2DistanceJointDef.prototype.Initialize=function(a,c,b,d){this.body1=a;this.body2=c;this.localAnchor1.SetV(this.body1.GetLocalPoint(b));this.localAnchor2.SetV(this.body2.GetLocalPoint(d));a=d.x-b.x;b=d.y-b.y;this.length=Math.sqrt(a*a+b*b);this.dampingRatio=this.frequencyHz=0};var b2CircleDef=function(){b2ShapeDef.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2CircleDef.prototype,b2ShapeDef.prototype);b2CircleDef.prototype._super=function(){b2ShapeDef.prototype.__constructor.apply(this,arguments)};b2CircleDef.prototype.__constructor=function(){this.type=b2Shape.e_circleShape;this.radius=1};b2CircleDef.prototype.__varz=function(){this.localPosition=new b2Vec2(0,0)};b2CircleDef.prototype.localPosition=new b2Vec2(0,0);
b2CircleDef.prototype.radius=null;var b2MouseJoint=function(){b2Joint.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2MouseJoint.prototype,b2Joint.prototype);b2MouseJoint.prototype._super=function(){b2Joint.prototype.__constructor.apply(this,arguments)};
...
(b.col1.x*d+b.col2.x*e);b=-a.inv_dt*(b.col1.y*d+b.col2.y*e);d=this.m_impulse.x;e=this.m_impulse.y;this.m_impulse.x+=h;this.m_impulse.y+=b;h=this.m_impulse.Length();h>this.m_maxForce&&this.m_impulse.Multiply(this.m_maxForce/h);h=this.m_impulse.x-d;b=this.m_impulse.y-e;h=a.dt*h;a=a.dt*b;c.m_linearVelocity.x+=c.m_invMass*h;c.m_linearVelocity.y+=c.m_invMass*a;c.m_angularVelocity+=c.m_invI*(f*a-g*h)};b2MouseJoint.prototype.SolvePositionConstraints=function(){return true};var b2PrismaticJoint=function(){b2Joint.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2PrismaticJoint.prototype,b2Joint.prototype);b2PrismaticJoint.prototype._super=function(){b2Joint.prototype.__constructor.apply(this,arguments)};
...
b2PrismaticJoint.prototype.GetJointSpeed=function(){var a=this.m_body1,c=this.m_body2,b;b=a.m_xf.R;var d=this.m_localAnchor1.x-a.m_sweep.localCenter.x,e=this.m_localAnchor1.y-a.m_sweep.localCenter.y,f=b.col1.x*d+b.col2.x*e;e=b.col1.y*d+b.col2.y*e;d=f;b=c.m_xf.R;var g=this.m_localAnchor2.x-c.m_sweep.localCenter.x,h=this.m_localAnchor2.y-c.m_sweep.localCenter.y;f=b.col1.x*g+b.col2.x*h;h=b.col1.y*g+b.col2.y*h;g=f;b=c.m_sweep.c.x+g-(a.m_sweep.c.x+d);f=c.m_sweep.c.y+h-(a.m_sweep.c.y+e);var i=a.GetWorldVector(this.m_localXAxis1),
...
this.m_linearJacobian.angular2;this.m_linearMass=1/this.m_linearMass;this.m_angularMass=k+l;if(this.m_angularMass>Number.MIN_VALUE)this.m_angularMass=1/this.m_angularMass;if(this.m_enableLimit||this.m_enableMotor){d=c.m_xf.R;m=d.col1.x*this.m_localXAxis1.x+d.col2.x*this.m_localXAxis1.y;d=d.col1.y*this.m_localXAxis1.x+d.col2.y*this.m_localXAxis1.y;this.m_motorJacobian.linear1.x=-m;this.m_motorJacobian.linear1.y=-d;this.m_motorJacobian.linear2.x=m;this.m_motorJacobian.linear2.y=d;this.m_motorJacobian.angular1=
-(n*d-o*m);this.m_motorJacobian.angular2=h*d-i*m;this.m_motorMass=e+k*this.m_motorJacobian.angular1*this.m_motorJacobian.angular1+j+l*this.m_motorJacobian.angular2*this.m_motorJacobian.angular2;this.m_motorMass=1/this.m_motorMass;if(this.m_enableLimit){f=m*(n-f)+d*(o-g);if(b2Math.b2Abs(this.m_upperTranslation-this.m_lowerTranslation)<2*b2Settings.b2_linearSlop)this.m_limitState=b2Joint.e_equalLimits;else if(f<=this.m_lowerTranslation){if(this.m_limitState!=b2Joint.e_atLowerLimit)this.m_limitForce=
0;this.m_limitState=b2Joint.e_atLowerLimit}else if(f>=this.m_upperTranslation){if(this.m_limitState!=b2Joint.e_atUpperLimit)this.m_limitForce=0;this.m_limitState=b2Joint.e_atUpperLimit}else{this.m_limitState=b2Joint.e_inactiveLimit;this.m_limitForce=0}}}if(this.m_enableMotor==false)this.m_motorForce=0;if(this.m_enableLimit==false)this.m_limitForce=0;if(a.warmStarting){f=a.dt*(this.m_force*this.m_linearJacobian.linear1.y+(this.m_motorForce+this.m_limitForce)*this.m_motorJacobian.linear1.y);g=a.dt*
(this.m_force*this.m_linearJacobian.linear2.x+(this.m_motorForce+this.m_limitForce)*this.m_motorJacobian.linear2.x);h=a.dt*(this.m_force*this.m_linearJacobian.linear2.y+(this.m_motorForce+this.m_limitForce)*this.m_motorJacobian.linear2.y);i=a.dt*(this.m_force*this.m_linearJacobian.angular1-this.m_torque+(this.m_motorForce+this.m_limitForce)*this.m_motorJacobian.angular1);n=a.dt*(this.m_force*this.m_linearJacobian.angular2+this.m_torque+(this.m_motorForce+this.m_limitForce)*this.m_motorJacobian.angular2);
c.m_linearVelocity.x+=e*a.dt*(this.m_force*this.m_linearJacobian.linear1.x+(this.m_motorForce+this.m_limitForce)*this.m_motorJacobian.linear1.x);c.m_linearVelocity.y+=e*f;c.m_angularVelocity+=k*i;b.m_linearVelocity.x+=j*g;b.m_linearVelocity.y+=j*h;b.m_angularVelocity+=l*n}else this.m_motorForce=this.m_limitForce=this.m_torque=this.m_force=0;this.m_limitPositionImpulse=0};
b2PrismaticJoint.prototype.SolveVelocityConstraints=function(a){var c=this.m_body1,b=this.m_body2,d=c.m_invMass,e=b.m_invMass,f=c.m_invI,g=b.m_invI,h;h=this.m_linearJacobian.Compute(c.m_linearVelocity,c.m_angularVelocity,b.m_linearVelocity,b.m_angularVelocity);h=-a.inv_dt*this.m_linearMass*h;this.m_force+=h;h=a.dt*h;c.m_linearVelocity.x+=d*h*this.m_linearJacobian.linear1.x;c.m_linearVelocity.y+=d*h*this.m_linearJacobian.linear1.y;c.m_angularVelocity+=f*h*this.m_linearJacobian.angular1;b.m_linearVelocity.x+=
e*h*this.m_linearJacobian.linear2.x;b.m_linearVelocity.y+=e*h*this.m_linearJacobian.linear2.y;b.m_angularVelocity+=g*h*this.m_linearJacobian.angular2;h=-a.inv_dt*this.m_angularMass*(b.m_angularVelocity-c.m_angularVelocity);this.m_torque+=h;h=a.dt*h;c.m_angularVelocity-=f*h;b.m_angularVelocity+=g*h;if(this.m_enableMotor&&this.m_limitState!=b2Joint.e_equalLimits){h=this.m_motorJacobian.Compute(c.m_linearVelocity,c.m_angularVelocity,b.m_linearVelocity,b.m_angularVelocity)-this.m_motorSpeed;h=-a.inv_dt*
this.m_motorMass*h;var i=this.m_motorForce;this.m_motorForce=b2Math.b2Clamp(this.m_motorForce+h,-this.m_maxMotorForce,this.m_maxMotorForce);h=this.m_motorForce-i;h=a.dt*h;c.m_linearVelocity.x+=d*h*this.m_motorJacobian.linear1.x;c.m_linearVelocity.y+=d*h*this.m_motorJacobian.linear1.y;c.m_angularVelocity+=f*h*this.m_motorJacobian.angular1;b.m_linearVelocity.x+=e*h*this.m_motorJacobian.linear2.x;b.m_linearVelocity.y+=e*h*this.m_motorJacobian.linear2.y;b.m_angularVelocity+=g*h*this.m_motorJacobian.angular2}if(this.m_enableLimit&&
...
b2PrismaticJoint.prototype.SolvePositionConstraints=function(){var a,c,b=this.m_body1,d=this.m_body2,e=b.m_invMass,f=d.m_invMass,g=b.m_invI,h=d.m_invI,i,j;i=b.m_xf.R;var k=this.m_localAnchor1.x-b.m_sweep.localCenter.x,l=this.m_localAnchor1.y-b.m_sweep.localCenter.y;j=i.col1.x*k+i.col2.x*l;l=i.col1.y*k+i.col2.y*l;k=j;i=d.m_xf.R;var m=this.m_localAnchor2.x-d.m_sweep.localCenter.x;a=this.m_localAnchor2.y-d.m_sweep.localCenter.y;j=i.col1.x*m+i.col2.x*a;a=i.col1.y*m+i.col2.y*a;m=j;i=b.m_sweep.c.x+k;l=
b.m_sweep.c.y+l;m=d.m_sweep.c.x+m;a=d.m_sweep.c.y+a;m=m-i;a=a-l;i=b.m_xf.R;var n=(i.col1.x*this.m_localYAxis1.x+i.col2.x*this.m_localYAxis1.y)*m+(i.col1.y*this.m_localYAxis1.x+i.col2.y*this.m_localYAxis1.y)*a;n=b2Math.b2Clamp(n,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);c=-this.m_linearMass*n;b.m_sweep.c.x+=e*c*this.m_linearJacobian.linear1.x;b.m_sweep.c.y+=e*c*this.m_linearJacobian.linear1.y;b.m_sweep.a+=g*c*this.m_linearJacobian.angular1;d.m_sweep.c.x+=f*c*this.m_linearJacobian.linear2.x;
d.m_sweep.c.y+=f*c*this.m_linearJacobian.linear2.y;d.m_sweep.a+=h*c*this.m_linearJacobian.angular2;n=b2Math.b2Abs(n);c=d.m_sweep.a-b.m_sweep.a-this.m_refAngle;c=b2Math.b2Clamp(c,-b2Settings.b2_maxAngularCorrection,b2Settings.b2_maxAngularCorrection);var o=-this.m_angularMass*c;b.m_sweep.a-=b.m_invI*o;d.m_sweep.a+=d.m_invI*o;b.SynchronizeTransform();d.SynchronizeTransform();o=b2Math.b2Abs(c);if(this.m_enableLimit&&this.m_limitState!=b2Joint.e_inactiveLimit){i=b.m_xf.R;k=this.m_localAnchor1.x-b.m_sweep.localCenter.x;
l=this.m_localAnchor1.y-b.m_sweep.localCenter.y;j=i.col1.x*k+i.col2.x*l;l=i.col1.y*k+i.col2.y*l;k=j;i=d.m_xf.R;m=this.m_localAnchor2.x-d.m_sweep.localCenter.x;a=this.m_localAnchor2.y-d.m_sweep.localCenter.y;j=i.col1.x*m+i.col2.x*a;a=i.col1.y*m+i.col2.y*a;m=j;i=b.m_sweep.c.x+k;l=b.m_sweep.c.y+l;m=d.m_sweep.c.x+m;a=d.m_sweep.c.y+a;m=m-i;a=a-l;i=b.m_xf.R;i=(i.col1.x*this.m_localXAxis1.x+i.col2.x*this.m_localXAxis1.y)*m+(i.col1.y*this.m_localXAxis1.x+i.col2.y*this.m_localXAxis1.y)*a;a=0;if(this.m_limitState==
b2Joint.e_equalLimits){a=b2Math.b2Clamp(i,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection);a=-this.m_motorMass*a;n=b2Math.b2Max(n,b2Math.b2Abs(c))}else if(this.m_limitState==b2Joint.e_atLowerLimit){a=i-this.m_lowerTranslation;n=b2Math.b2Max(n,-a);a=b2Math.b2Clamp(a+b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);a=-this.m_motorMass*a;c=this.m_limitPositionImpulse;this.m_limitPositionImpulse=b2Math.b2Max(this.m_limitPositionImpulse+a,0);a=this.m_limitPositionImpulse-
c}else if(this.m_limitState==b2Joint.e_atUpperLimit){a=i-this.m_upperTranslation;n=b2Math.b2Max(n,a);a=b2Math.b2Clamp(a-b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection);a=-this.m_motorMass*a;c=this.m_limitPositionImpulse;this.m_limitPositionImpulse=b2Math.b2Min(this.m_limitPositionImpulse+a,0);a=this.m_limitPositionImpulse-c}b.m_sweep.c.x+=e*a*this.m_motorJacobian.linear1.x;b.m_sweep.c.y+=e*a*this.m_motorJacobian.linear1.y;b.m_sweep.a+=g*a*this.m_motorJacobian.angular1;d.m_sweep.c.x+=
f*a*this.m_motorJacobian.linear2.x;d.m_sweep.c.y+=f*a*this.m_motorJacobian.linear2.y;d.m_sweep.a+=h*a*this.m_motorJacobian.angular2;b.SynchronizeTransform();d.SynchronizeTransform()}return n<=b2Settings.b2_linearSlop&&o<=b2Settings.b2_angularSlop};var b2RevoluteJointDef=function(){b2JointDef.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2RevoluteJointDef.prototype,b2JointDef.prototype);b2RevoluteJointDef.prototype._super=function(){b2JointDef.prototype.__constructor.apply(this,arguments)};
...
b2RevoluteJointDef.prototype.Initialize=function(a,c,b){this.body1=a;this.body2=c;this.localAnchor1=this.body1.GetLocalPoint(b);this.localAnchor2=this.body2.GetLocalPoint(b);this.referenceAngle=this.body2.GetAngle()-this.body1.GetAngle()};var b2PulleyJointDef=function(){b2JointDef.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2PulleyJointDef.prototype,b2JointDef.prototype);b2PulleyJointDef.prototype._super=function(){b2JointDef.prototype.__constructor.apply(this,arguments)};
b2PulleyJointDef.prototype.__constructor=function(){this.type=b2Joint.e_pulleyJoint;this.groundAnchor1.Set(-1,1);this.groundAnchor2.Set(1,1);this.localAnchor1.Set(-1,0);this.localAnchor2.Set(1,0);this.maxLength2=this.length2=this.maxLength1=this.length1=0;this.ratio=1;this.collideConnected=true};b2PulleyJointDef.prototype.__varz=function(){this.groundAnchor1=new b2Vec2;this.groundAnchor2=new b2Vec2;this.localAnchor1=new b2Vec2;this.localAnchor2=new b2Vec2};
b2PulleyJointDef.prototype.groundAnchor1=new b2Vec2;b2PulleyJointDef.prototype.groundAnchor2=new b2Vec2;b2PulleyJointDef.prototype.localAnchor1=new b2Vec2;b2PulleyJointDef.prototype.localAnchor2=new b2Vec2;b2PulleyJointDef.prototype.length1=null;b2PulleyJointDef.prototype.maxLength1=null;b2PulleyJointDef.prototype.length2=null;b2PulleyJointDef.prototype.maxLength2=null;b2PulleyJointDef.prototype.ratio=null;
...
this.ratio};var b2CircleShape=function(){b2Shape.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2CircleShape.prototype,b2Shape.prototype);b2CircleShape.prototype._super=function(){b2Shape.prototype.__constructor.apply(this,arguments)};b2CircleShape.prototype.__constructor=function(a){this._super(a);this.m_type=b2Shape.e_circleShape;this.m_localPosition.SetV(a.localPosition);this.m_radius=a.radius};b2CircleShape.prototype.__varz=function(){this.m_localPosition=new b2Vec2};
...
b2CircleShape.prototype.TestSegment=function(a,c,b,d,e){var f=a.R,g=d.p1.x-(a.position.x+(f.col1.x*this.m_localPosition.x+f.col2.x*this.m_localPosition.y));a=d.p1.y-(a.position.y+(f.col1.y*this.m_localPosition.x+f.col2.y*this.m_localPosition.y));var h=g*g+a*a-this.m_radius*this.m_radius;if(h<0)return false;f=d.p2.x-d.p1.x;d=d.p2.y-d.p1.y;var i=g*f+a*d,j=f*f+d*d;h=i*i-j*h;if(h<0||j<Number.MIN_VALUE)return false;h=-(i+Math.sqrt(h));if(0<=h&&h<=e*j){h/=j;c[0]=h;b.x=g+h*f;b.y=a+h*d;b.Normalize();return true}return false};
...
b2CircleShape.prototype.UpdateSweepRadius=function(a){var c=this.m_localPosition.x-a.x;a=this.m_localPosition.y-a.y;c=Math.sqrt(c*c+a*a);this.m_sweepRadius=c+this.m_radius-b2Settings.b2_toiSlop};var b2GearJoint=function(){b2Joint.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2GearJoint.prototype,b2Joint.prototype);b2GearJoint.prototype._super=function(){b2Joint.prototype.__constructor.apply(this,arguments)};
b2GearJoint.prototype.__constructor=function(a){this._super(a);var c=a.joint1.m_type,b=a.joint2.m_type;this.m_prismatic2=this.m_revolute2=this.m_prismatic1=this.m_revolute1=null;this.m_ground1=a.joint1.m_body1;this.m_body1=a.joint1.m_body2;if(c==b2Joint.e_revoluteJoint){this.m_revolute1=a.joint1;this.m_groundAnchor1.SetV(this.m_revolute1.m_localAnchor1);this.m_localAnchor1.SetV(this.m_revolute1.m_localAnchor2);c=this.m_revolute1.GetJointAngle()}else{this.m_prismatic1=a.joint1;this.m_groundAnchor1.SetV(this.m_prismatic1.m_localAnchor1);
this.m_localAnchor1.SetV(this.m_prismatic1.m_localAnchor2);c=this.m_prismatic1.GetJointTranslation()}this.m_ground2=a.joint2.m_body1;this.m_body2=a.joint2.m_body2;if(b==b2Joint.e_revoluteJoint){this.m_revolute2=a.joint2;this.m_groundAnchor2.SetV(this.m_revolute2.m_localAnchor1);this.m_localAnchor2.SetV(this.m_revolute2.m_localAnchor2);b=this.m_revolute2.GetJointAngle()}else{this.m_prismatic2=a.joint2;this.m_groundAnchor2.SetV(this.m_prismatic2.m_localAnchor1);this.m_localAnchor2.SetV(this.m_prismatic2.m_localAnchor2);
...
b2GearJoint.prototype.GetReactionTorque=function(){var a=this.m_body2.m_xf.R,c=this.m_localAnchor1.x-this.m_body2.m_sweep.localCenter.x,b=this.m_localAnchor1.y-this.m_body2.m_sweep.localCenter.y,d=a.col1.x*c+a.col2.x*b;b=a.col1.y*c+a.col2.y*b;c=d;return d=this.m_force*this.m_J.angular2-(c*this.m_force*this.m_J.linear2.y-b*this.m_force*this.m_J.linear2.x)};b2GearJoint.prototype.GetRatio=function(){return this.m_ratio};
b2GearJoint.prototype.InitVelocityConstraints=function(a){var c=this.m_ground1,b=this.m_ground2,d=this.m_body1,e=this.m_body2,f,g,h,i,j,k=0;this.m_J.SetZero();if(this.m_revolute1){this.m_J.angular1=-1;k+=d.m_invI}else{i=c.m_xf.R;f=this.m_prismatic1.m_localXAxis1;c=i.col1.x*f.x+i.col2.x*f.y;f=i.col1.y*f.x+i.col2.y*f.y;i=d.m_xf.R;g=this.m_localAnchor1.x-d.m_sweep.localCenter.x;h=this.m_localAnchor1.y-d.m_sweep.localCenter.y;j=i.col1.x*g+i.col2.x*h;h=i.col1.y*g+i.col2.y*h;g=j;i=g*f-h*c;this.m_J.linear1.Set(-c,
-f);this.m_J.angular1=-i;k+=d.m_invMass+d.m_invI*i*i}if(this.m_revolute2){this.m_J.angular2=-this.m_ratio;k+=this.m_ratio*this.m_ratio*e.m_invI}else{i=b.m_xf.R;f=this.m_prismatic2.m_localXAxis1;c=i.col1.x*f.x+i.col2.x*f.y;f=i.col1.y*f.x+i.col2.y*f.y;i=e.m_xf.R;g=this.m_localAnchor2.x-e.m_sweep.localCenter.x;h=this.m_localAnchor2.y-e.m_sweep.localCenter.y;j=i.col1.x*g+i.col2.x*h;h=i.col1.y*g+i.col2.y*h;g=j;i=g*f-h*c;this.m_J.linear2.Set(-this.m_ratio*c,-this.m_ratio*f);this.m_J.angular2=-this.m_ratio*
i;k+=this.m_ratio*this.m_ratio*(e.m_invMass+e.m_invI*i*i)}this.m_mass=1/k;if(a.warmStarting){a=a.dt*this.m_force;d.m_linearVelocity.x+=d.m_invMass*a*this.m_J.linear1.x;d.m_linearVelocity.y+=d.m_invMass*a*this.m_J.linear1.y;d.m_angularVelocity+=d.m_invI*a*this.m_J.angular1;e.m_linearVelocity.x+=e.m_invMass*a*this.m_J.linear2.x;e.m_linearVelocity.y+=e.m_invMass*a*this.m_J.linear2.y;e.m_angularVelocity+=e.m_invI*a*this.m_J.angular2}else this.m_force=0};
b2GearJoint.prototype.SolveVelocityConstraints=function(a){var c=this.m_body1,b=this.m_body2,d=this.m_J.Compute(c.m_linearVelocity,c.m_angularVelocity,b.m_linearVelocity,b.m_angularVelocity);d=-a.inv_dt*this.m_mass*d;this.m_force+=d;a=a.dt*d;c.m_linearVelocity.x+=c.m_invMass*a*this.m_J.linear1.x;c.m_linearVelocity.y+=c.m_invMass*a*this.m_J.linear1.y;c.m_angularVelocity+=c.m_invI*a*this.m_J.angular1;b.m_linearVelocity.x+=b.m_invMass*a*this.m_J.linear2.x;b.m_linearVelocity.y+=b.m_invMass*a*this.m_J.linear2.y;
...
b2GearJointDef.prototype.joint2=null;b2GearJointDef.prototype.ratio=null;var ClipVertex=function(){this.__varz();this.__constructor.apply(this,arguments)};ClipVertex.prototype.__constructor=function(){};ClipVertex.prototype.__varz=function(){this.v=new b2Vec2;this.id=new b2ContactID};ClipVertex.prototype.v=new b2Vec2;ClipVertex.prototype.id=new b2ContactID;var b2NullContact=function(){b2Contact.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2NullContact.prototype,b2Contact.prototype);b2NullContact.prototype._super=function(){b2Contact.prototype.__constructor.apply(this,arguments)};b2NullContact.prototype.__constructor=function(){};b2NullContact.prototype.__varz=function(){};b2NullContact.prototype.Evaluate=function(){};b2NullContact.prototype.GetManifolds=function(){return null};var b2ManifoldPoint=function(){this.__varz();this.__constructor.apply(this,arguments)};b2ManifoldPoint.prototype.__constructor=function(){};b2ManifoldPoint.prototype.__varz=function(){this.localPoint1=new b2Vec2;this.localPoint2=new b2Vec2;this.id=new b2ContactID};b2ManifoldPoint.prototype.localPoint1=new b2Vec2;b2ManifoldPoint.prototype.localPoint2=new b2Vec2;b2ManifoldPoint.prototype.separation=null;b2ManifoldPoint.prototype.normalImpulse=null;b2ManifoldPoint.prototype.tangentImpulse=null;
b2ManifoldPoint.prototype.id=new b2ContactID;b2ManifoldPoint.prototype.Reset=function(){this.localPoint1.SetZero();this.localPoint2.SetZero();this.tangentImpulse=this.normalImpulse=this.separation=0;this.id.key=0};b2ManifoldPoint.prototype.Set=function(a){this.localPoint1.SetV(a.localPoint1);this.localPoint2.SetV(a.localPoint2);this.separation=a.separation;this.normalImpulse=a.normalImpulse;this.tangentImpulse=a.tangentImpulse;this.id.key=a.id.key};var b2ContactSolver=function(){this.__varz();this.__constructor.apply(this,arguments)};
b2ContactSolver.prototype.__constructor=function(a,c,b,d){var e;this.m_step.dt=a.dt;this.m_step.inv_dt=a.inv_dt;this.m_step.maxIterations=a.maxIterations;this.m_allocator=d;a=0;var f;for(a=this.m_constraintCount=0;a<b;++a){e=c[a];this.m_constraintCount+=e.m_manifoldCount}for(a=0;a<this.m_constraintCount;a++)this.m_constraints[a]=new b2ContactConstraint;for(a=d=0;a<b;++a){e=c[a];var g=e.m_shape1.m_body,h=e.m_shape2.m_body,i=e.m_manifoldCount,j=e.GetManifolds(),k=e.m_friction;e=e.m_restitution;for(var l=
g.m_linearVelocity.x,m=g.m_linearVelocity.y,n=h.m_linearVelocity.x,o=h.m_linearVelocity.y,p=g.m_angularVelocity,q=h.m_angularVelocity,s=0;s<i;++s){var w=j[s],x=w.normal.x,t=w.normal.y,u=this.m_constraints[d];u.body1=g;u.body2=h;u.manifold=w;u.normal.x=x;u.normal.y=t;u.pointCount=w.pointCount;u.friction=k;u.restitution=e;for(var y=0;y<u.pointCount;++y){var r=w.points[y],v=u.points[y];v.normalImpulse=r.normalImpulse;v.tangentImpulse=r.tangentImpulse;v.separation=r.separation;v.positionImpulse=0;v.localAnchor1.SetV(r.localPoint1);
v.localAnchor2.SetV(r.localPoint2);var z;f=g.m_xf.R;var A=r.localPoint1.x-g.m_sweep.localCenter.x,D=r.localPoint1.y-g.m_sweep.localCenter.y;z=f.col1.x*A+f.col2.x*D;D=f.col1.y*A+f.col2.y*D;A=z;v.r1.Set(A,D);f=h.m_xf.R;var E=r.localPoint2.x-h.m_sweep.localCenter.x;r=r.localPoint2.y-h.m_sweep.localCenter.y;z=f.col1.x*E+f.col2.x*r;r=f.col1.y*E+f.col2.y*r;E=z;v.r2.Set(E,r);f=A*A+D*D;z=E*E+r*r;var F=A*x+D*t,C=E*x+r*t,B=g.m_invMass+h.m_invMass;B+=g.m_invI*(f-F*F)+h.m_invI*(z-C*C);v.normalMass=1/B;B=g.m_mass*
g.m_invMass+h.m_mass*h.m_invMass;B+=g.m_mass*g.m_invI*(f-F*F)+h.m_mass*h.m_invI*(z-C*C);v.equalizedMass=1/B;C=t;B=-x;F=A*C+D*B;C=E*C+r*B;B=g.m_invMass+h.m_invMass;B+=g.m_invI*(f-F*F)+h.m_invI*(z-C*C);v.tangentMass=1/B;v.velocityBias=0;if(v.separation>0)v.velocityBias=-60*v.separation;z=n+-q*r-l- -p*D;A=u.normal.x*z+u.normal.y*(o+q*E-m-p*A);if(A<-b2Settings.b2_velocityThreshold)v.velocityBias+=-u.restitution*A}++d}}};
...
b2ContactSolver.prototype.SolveVelocityConstraints=function(){for(var a=0,c,b,d,e,f,g,h=0;h<this.m_constraintCount;++h){var i=this.m_constraints[h],j=i.body1,k=i.body2,l=j.m_angularVelocity,m=k.m_angularVelocity,n=j.m_linearVelocity,o=k.m_linearVelocity,p=j.m_invMass,q=j.m_invI,s=k.m_invMass,w=k.m_invI,x=i.normal.x,t=i.normal.y,u=t,y=-x,r=i.friction,v=i.pointCount;for(a=0;a<v;++a){c=i.points[a];b=o.x+-m*c.r2.y-n.x- -l*c.r1.y;d=o.y+m*c.r2.x-n.y-l*c.r1.x;e=b*x+d*t;e=-c.normalMass*(e-c.velocityBias);
b=b*u+d*y;d=c.tangentMass*-b;b=b2Math.b2Max(c.normalImpulse+e,0);e=b-c.normalImpulse;f=r*c.normalImpulse;f=b2Math.b2Clamp(c.tangentImpulse+d,-f,f);d=f-c.tangentImpulse;g=e*x+d*u;e=e*t+d*y;n.x-=p*g;n.y-=p*e;l-=q*(c.r1.x*e-c.r1.y*g);o.x+=s*g;o.y+=s*e;m+=w*(c.r2.x*e-c.r2.y*g);c.normalImpulse=b;c.tangentImpulse=f}j.m_angularVelocity=l;k.m_angularVelocity=m}};
...
b2ContactSolver.prototype.SolvePositionConstraints=function(a){for(var c=0,b,d,e=0;e<this.m_constraintCount;++e)for(var f=this.m_constraints[e],g=f.body1,h=f.body2,i=g.m_sweep.c,j=g.m_sweep.a,k=h.m_sweep.c,l=h.m_sweep.a,m=g.m_mass*g.m_invMass,n=g.m_mass*g.m_invI,o=h.m_mass*h.m_invMass,p=h.m_mass*h.m_invI,q=f.normal.x,s=f.normal.y,w=f.pointCount,x=0;x<w;++x){var t=f.points[x];b=g.m_xf.R;d=g.m_sweep.localCenter;var u=t.localAnchor1.x-d.x,y=t.localAnchor1.y-d.y;v=b.col1.x*u+b.col2.x*y;y=b.col1.y*u+b.col2.y*
y;u=v;b=h.m_xf.R;d=h.m_sweep.localCenter;var r=t.localAnchor2.x-d.x;d=t.localAnchor2.y-d.y;var v=b.col1.x*r+b.col2.x*d;d=b.col1.y*r+b.col2.y*d;r=v;b=(k.x+r-(i.x+u))*q+(k.y+d-(i.y+y))*s+t.separation;c=b2Math.b2Min(c,b);b=a*b2Math.b2Clamp(b+b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0);b=-t.equalizedMass*b;v=t.positionImpulse;t.positionImpulse=b2Math.b2Max(v+b,0);b=t.positionImpulse-v;t=b*q;b=b*s;i.x-=m*t;i.y-=m*b;j-=n*(u*b-y*t);g.m_sweep.a=j;g.SynchronizeTransform();k.x+=o*t;k.y+=
o*b;l+=p*(r*b-d*t);h.m_sweep.a=l;h.SynchronizeTransform()}return c>=-1.5*b2Settings.b2_linearSlop};var b2ContactResult=function(){this.__varz();this.__constructor.apply(this,arguments)};b2ContactResult.prototype.__constructor=function(){};b2ContactResult.prototype.__varz=function(){this.position=new b2Vec2;this.normal=new b2Vec2;this.id=new b2ContactID};b2ContactResult.prototype.shape1=null;b2ContactResult.prototype.shape2=null;b2ContactResult.prototype.position=new b2Vec2;b2ContactResult.prototype.normal=new b2Vec2;b2ContactResult.prototype.normalImpulse=null;
...
b2Island.prototype.Solve=function(a,c,b,d){var e=0,f;for(e=0;e<this.m_bodyCount;++e){f=this.m_bodies[e];if(!f.IsStatic()){f.m_linearVelocity.x+=a.dt*(c.x+f.m_invMass*f.m_force.x);f.m_linearVelocity.y+=a.dt*(c.y+f.m_invMass*f.m_force.y);f.m_angularVelocity+=a.dt*f.m_invI*f.m_torque;f.m_force.SetZero();f.m_torque=0;f.m_linearVelocity.Multiply(b2Math.b2Clamp(1-a.dt*f.m_linearDamping,0,1));f.m_angularVelocity*=b2Math.b2Clamp(1-a.dt*f.m_angularDamping,0,1);if(f.m_linearVelocity.LengthSquared()>b2Settings.b2_maxLinearVelocitySquared){f.m_linearVelocity.Normalize();
f.m_linearVelocity.x*=b2Settings.b2_maxLinearVelocity;f.m_linearVelocity.y*=b2Settings.b2_maxLinearVelocity}if(f.m_angularVelocity*f.m_angularVelocity>b2Settings.b2_maxAngularVelocitySquared)f.m_angularVelocity=f.m_angularVelocity<0?-b2Settings.b2_maxAngularVelocity:b2Settings.b2_maxAngularVelocity}}c=new b2ContactSolver(a,this.m_contacts,this.m_contactCount,this.m_allocator);c.InitVelocityConstraints(a);for(e=0;e<this.m_jointCount;++e){f=this.m_joints[e];f.InitVelocityConstraints(a)}for(e=0;e<a.maxIterations;++e){c.SolveVelocityConstraints();
for(var g=0;g<this.m_jointCount;++g){f=this.m_joints[g];f.SolveVelocityConstraints(a)}}c.FinalizeVelocityConstraints();for(e=0;e<this.m_bodyCount;++e){f=this.m_bodies[e];if(!f.IsStatic()){f.m_sweep.c0.SetV(f.m_sweep.c);f.m_sweep.a0=f.m_sweep.a;f.m_sweep.c.x+=a.dt*f.m_linearVelocity.x;f.m_sweep.c.y+=a.dt*f.m_linearVelocity.y;f.m_sweep.a+=a.dt*f.m_angularVelocity;f.SynchronizeTransform()}}if(b){for(e=0;e<this.m_jointCount;++e){f=this.m_joints[e];f.InitPositionConstraints()}for(this.m_positionIterationCount=
0;this.m_positionIterationCount<a.maxIterations;++this.m_positionIterationCount){b=c.SolvePositionConstraints(b2Settings.b2_contactBaumgarte);g=true;for(e=0;e<this.m_jointCount;++e){f=this.m_joints[e];f=f.SolvePositionConstraints();g=g&&f}if(b&&g)break}}this.Report(c.m_constraints);if(d){d=Number.MAX_VALUE;c=b2Settings.b2_linearSleepTolerance*b2Settings.b2_linearSleepTolerance;b=b2Settings.b2_angularSleepTolerance*b2Settings.b2_angularSleepTolerance;for(e=0;e<this.m_bodyCount;++e){f=this.m_bodies[e];
if(f.m_invMass!=0){if((f.m_flags&b2Body.e_allowSleepFlag)==0)d=f.m_sleepTime=0;if((f.m_flags&b2Body.e_allowSleepFlag)==0||f.m_angularVelocity*f.m_angularVelocity>b||b2Math.b2Dot(f.m_linearVelocity,f.m_linearVelocity)>c)d=f.m_sleepTime=0;else{f.m_sleepTime+=a.dt;d=b2Math.b2Min(d,f.m_sleepTime)}}}if(d>=b2Settings.b2_timeToSleep)for(e=0;e<this.m_bodyCount;++e){f=this.m_bodies[e];f.m_flags|=b2Body.e_sleepFlag;f.m_linearVelocity.SetZero();f.m_angularVelocity=0}}};
b2Island.prototype.SolveTOI=function(a){var c=0,b=new b2ContactSolver(a,this.m_contacts,this.m_contactCount,this.m_allocator);for(c=0;c<a.maxIterations;++c)b.SolveVelocityConstraints();for(c=0;c<this.m_bodyCount;++c){var d=this.m_bodies[c];if(!d.IsStatic()){d.m_sweep.c0.SetV(d.m_sweep.c);d.m_sweep.a0=d.m_sweep.a;d.m_sweep.c.x+=a.dt*d.m_linearVelocity.x;d.m_sweep.c.y+=a.dt*d.m_linearVelocity.y;d.m_sweep.a+=a.dt*d.m_angularVelocity;d.SynchronizeTransform()}}for(c=0;c<a.maxIterations;++c)if(b.SolvePositionConstraints(0.75))break;
this.Report(b.m_constraints)};
b2Island.prototype.Report=function(a){if(this.m_listener!=null)for(var c=0;c<this.m_contactCount;++c){var b=this.m_contacts[c],d=a[c],e=b2Island.s_reportCR;e.shape1=b.m_shape1;e.shape2=b.m_shape2;var f=e.shape1.m_body,g=b.m_manifoldCount;b=b.GetManifolds();for(var h=0;h<g;++h){var i=b[h];e.normal.SetV(i.normal);for(var j=0;j<i.pointCount;++j){var k=i.points[j],l=d.points[j];e.position=f.GetWorldPoint(k.localPoint1);e.normalImpulse=l.normalImpulse;e.tangentImpulse=l.tangentImpulse;e.id.key=k.id.key;
this.m_listener.Result(e)}}}};b2Island.prototype.AddBody=function(a){this.m_bodies[this.m_bodyCount++]=a};b2Island.prototype.AddContact=function(a){this.m_contacts[this.m_contactCount++]=a};b2Island.prototype.AddJoint=function(a){this.m_joints[this.m_jointCount++]=a};var b2ContactManager=function(){b2PairCallback.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2ContactManager.prototype,b2PairCallback.prototype);b2ContactManager.prototype._super=function(){b2PairCallback.prototype.__constructor.apply(this,arguments)};b2ContactManager.prototype.__constructor=function(){this.m_world=null;this.m_destroyImmediate=false};b2ContactManager.prototype.__varz=function(){this.m_nullContact=new b2NullContact};
...
b2World.prototype.CreateBody=function(a){if(this.m_lock==true)return null;a=new b2Body(a,this);a.m_prev=null;if(a.m_next=this.m_bodyList)this.m_bodyList.m_prev=a;this.m_bodyList=a;++this.m_bodyCount;return a};
b2World.prototype.DestroyBody=function(a){if(this.m_lock!=true){for(var c=a.m_jointList;c;){var b=c;c=c.next;this.m_destructionListener&&this.m_destructionListener.SayGoodbyeJoint(b.joint);this.DestroyJoint(b.joint)}for(c=a.m_shapeList;c;){b=c;c=c.m_next;this.m_destructionListener&&this.m_destructionListener.SayGoodbyeShape(b);b.DestroyProxy(this.m_broadPhase);b2Shape.Destroy(b,this.m_blockAllocator)}if(a.m_prev)a.m_prev.m_next=a.m_next;if(a.m_next)a.m_next.m_prev=a.m_prev;if(a==this.m_bodyList)this.m_bodyList=
...
c.m_body2.m_jointList=c.m_node2;if(a.collideConnected==false){a=a.body1.m_shapeCount<a.body2.m_shapeCount?a.body1:a.body2;for(var b=a.m_shapeList;b;b=b.m_next)b.RefilterProxy(this.m_broadPhase,a.m_xf)}return c};
...
a.m_node2.prev;if(a.m_node2==d.m_jointList)d.m_jointList=a.m_node2.next;a.m_node2.prev=null;a.m_node2.next=null;b2Joint.Destroy(a,this.m_blockAllocator);--this.m_jointCount;if(c==false){a=b.m_shapeCount<d.m_shapeCount?b:d;for(c=a.m_shapeList;c;c=c.m_next)c.RefilterProxy(this.m_broadPhase,a.m_xf)}};b2World.prototype.Refilter=function(a){a.RefilterProxy(this.m_broadPhase,a.m_body.m_xf)};b2World.prototype.SetWarmStarting=function(a){b2World.m_warmStarting=a};
...
b2World.prototype.Step=function(a,c){this.m_lock=true;var b=new b2TimeStep;b.dt=a;b.maxIterations=c;b.inv_dt=a>0?1/a:0;b.dtRatio=this.m_inv_dt0*a;b.positionCorrection=b2World.m_positionCorrection;b.warmStarting=b2World.m_warmStarting;this.m_contactManager.Collide();b.dt>0&&this.Solve(b);b2World.m_continuousPhysics&&b.dt>0&&this.SolveTOI(b);this.DrawDebugData();this.m_inv_dt0=b.inv_dt;this.m_lock=false};
b2World.prototype.Query=function(a,c,b){var d=Array(b);a=this.m_broadPhase.QueryAABB(a,d,b);for(b=0;b<a;++b)c[b]=d[b];return a};b2World.prototype.GetBodyList=function(){return this.m_bodyList};b2World.prototype.GetJointList=function(){return this.m_jointList};
b2World.prototype.Solve=function(a){var c;this.m_positionIterationCount=0;var b=new b2Island(this.m_bodyCount,this.m_contactCount,this.m_jointCount,this.m_stackAllocator,this.m_contactListener);for(c=this.m_bodyList;c;c=c.m_next)c.m_flags&=~b2Body.e_islandFlag;for(var d=this.m_contactList;d;d=d.m_next)d.m_flags&=~b2Contact.e_islandFlag;for(d=this.m_jointList;d;d=d.m_next)d.m_islandFlag=false;d=Array(this.m_bodyCount);for(var e=this.m_bodyList;e;e=e.m_next)if(!(e.m_flags&(b2Body.e_islandFlag|b2Body.e_sleepFlag|
b2Body.e_frozenFlag)))if(!e.IsStatic()){b.Clear();var f=0;d[f++]=e;for(e.m_flags|=b2Body.e_islandFlag;f>0;){c=d[--f];b.AddBody(c);c.m_flags&=~b2Body.e_sleepFlag;if(!c.IsStatic()){for(var g,h=c.m_contactList;h;h=h.next)if(!(h.contact.m_flags&(b2Contact.e_islandFlag|b2Contact.e_nonSolidFlag)))if(h.contact.m_manifoldCount!=0){b.AddContact(h.contact);h.contact.m_flags|=b2Contact.e_islandFlag;g=h.other;if(!(g.m_flags&b2Body.e_islandFlag)){d[f++]=g;g.m_flags|=b2Body.e_islandFlag}}for(c=c.m_jointList;c;c=
c.next)if(c.joint.m_islandFlag!=true){b.AddJoint(c.joint);c.joint.m_islandFlag=true;g=c.other;if(!(g.m_flags&b2Body.e_islandFlag)){d[f++]=g;g.m_flags|=b2Body.e_islandFlag}}}}b.Solve(a,this.m_gravity,b2World.m_positionCorrection,this.m_allowSleep);if(b.m_positionIterationCount>this.m_positionIterationCount)this.m_positionIterationCount=b.m_positionIterationCount;for(f=0;f<b.m_bodyCount;++f){c=b.m_bodies[f];if(c.IsStatic())c.m_flags&=~b2Body.e_islandFlag}}for(c=this.m_bodyList;c;c=c.m_next)c.m_flags&
...
1;if(g.m_flags&b2Contact.e_toiFlag)b=g.m_toi;else{b=g.m_shape1;d=g.m_shape2;b=b.m_body;d=d.m_body;if((b.IsStatic()||b.IsSleeping())&&(d.IsStatic()||d.IsSleeping()))continue;var i=b.m_sweep.t0;if(b.m_sweep.t0<d.m_sweep.t0){i=d.m_sweep.t0;b.m_sweep.Advance(i)}else if(d.m_sweep.t0<b.m_sweep.t0){i=b.m_sweep.t0;d.m_sweep.Advance(i)}b=b2TimeOfImpact.TimeOfImpact(g.m_shape1,b.m_sweep,g.m_shape2,d.m_sweep);if(b>0&&b<1){b=(1-b)*i+b;if(b>1)b=1}g.m_toi=b;g.m_flags|=b2Contact.e_toiFlag}if(Number.MIN_VALUE<b&&
b<h){c=g;h=b}}if(c==null||1-100*Number.MIN_VALUE<h)break;b=c.m_shape1;d=c.m_shape2;b=b.m_body;d=d.m_body;b.Advance(h);d.Advance(h);c.Update(this.m_contactListener);c.m_flags&=~b2Contact.e_toiFlag;if(c.m_manifoldCount!=0){c=b;if(c.IsStatic())c=d;e.Clear();g=0;f[g++]=c;for(c.m_flags|=b2Body.e_islandFlag;g>0;){c=f[--g];e.AddBody(c);c.m_flags&=~b2Body.e_sleepFlag;if(!c.IsStatic())for(c=c.m_contactList;c;c=c.next)if(e.m_contactCount!=e.m_contactCapacity)if(!(c.contact.m_flags&(b2Contact.e_islandFlag|b2Contact.e_slowFlag|
b2Contact.e_nonSolidFlag)))if(c.contact.m_manifoldCount!=0){e.AddContact(c.contact);c.contact.m_flags|=b2Contact.e_islandFlag;b=c.other;if(!(b.m_flags&b2Body.e_islandFlag)){if(b.IsStatic()==false){b.Advance(h);b.WakeUp()}f[g++]=b;b.m_flags|=b2Body.e_islandFlag}}}g=new b2TimeStep;g.dt=(1-h)*a.dt;g.inv_dt=1/g.dt;g.maxIterations=a.maxIterations;e.SolveTOI(g);for(h=h=0;h<e.m_bodyCount;++h){c=e.m_bodies[h];c.m_flags&=~b2Body.e_islandFlag;if(!(c.m_flags&(b2Body.e_sleepFlag|b2Body.e_frozenFlag)))if(!c.IsStatic()){c.SynchronizeShapes()==
false&&this.m_boundaryListener!=null&&this.m_boundaryListener.Violation(c);for(c=c.m_contactList;c;c=c.next)c.contact.m_flags&=~b2Contact.e_toiFlag}}for(h=0;h<e.m_contactCount;++h){g=e.m_contacts[h];g.m_flags&=~(b2Contact.e_toiFlag|b2Contact.e_islandFlag)}this.m_broadPhase.Commit()}}};
...
1/b.m_quantizationFactor.y);h.Set(0.9,0.3,0.9);for(c=0;c<b2Settings.b2_maxProxies;++c){k=b.m_proxyPool[c];if(k.IsValid()!=false){j.lowerBound.x=f.x+e.x*b.m_bounds[0][k.lowerBounds[0]].value;j.lowerBound.y=f.y+e.y*b.m_bounds[1][k.lowerBounds[1]].value;j.upperBound.x=f.x+e.x*b.m_bounds[0][k.upperBounds[0]].value;j.upperBound.y=f.y+e.y*b.m_bounds[1][k.upperBounds[1]].value;l[0].Set(j.lowerBound.x,j.lowerBound.y);l[1].Set(j.upperBound.x,j.lowerBound.y);l[2].Set(j.upperBound.x,j.upperBound.y);l[3].Set(j.lowerBound.x,
...
f.x+j.col2.x*f.y);l[c].y=e.center.y+(j.col1.y*f.x+j.col2.y*f.y);l[c].x=g;j=i.R;g=i.position.x+(j.col1.x*f.x+j.col2.x*f.y);l[c].y=i.position.y+(j.col1.y*f.x+j.col2.y*f.y);l[c].x=g}this.m_debugDraw.DrawPolygon(l,4,h)}}}if(a&b2DebugDraw.e_centerOfMassBit)for(b=this.m_bodyList;b;b=b.m_next){i=b2World.s_xf;i.R=b.m_xf.R;i.position=b.GetWorldCenter();this.m_debugDraw.DrawXForm(i)}}};var b2PolyAndCircleContact=function(){b2Contact.prototype.__varz.call(this);this.__varz();this.__constructor.apply(this,arguments)};extend(b2PolyAndCircleContact.prototype,b2Contact.prototype);b2PolyAndCircleContact.prototype._super=function(){b2Contact.prototype.__constructor.apply(this,arguments)};
...
b2CircleContact.prototype.Evaluate=function(a){var c,b,d;c=this.m_shape1.m_body;b=this.m_shape2.m_body;this.m0.Set(this.m_manifold);b2Collision.b2CollideCircles(this.m_manifold,this.m_shape1,c.m_xf,this.m_shape2,b.m_xf);var e=b2CircleContact.s_evalCP;e.shape1=this.m_shape1;e.shape2=this.m_shape2;e.friction=this.m_friction;e.restitution=this.m_restitution;if(this.m_manifold.pointCount>0){this.m_manifoldCount=1;var f=this.m_manifold.points[0];if(this.m0.pointCount==0){f.normalImpulse=0;f.tangentImpulse=
0;if(a){e.position=c.GetWorldPoint(f.localPoint1);c=c.GetLinearVelocityFromLocalPoint(f.localPoint1);b=b.GetLinearVelocityFromLocalPoint(f.localPoint2);e.velocity.Set(b.x-c.x,b.y-c.y);e.normal.SetV(this.m_manifold.normal);e.separation=f.separation;e.id.key=f.id._key;a.Add(e)}}else{d=this.m0.points[0];f.normalImpulse=d.normalImpulse;f.tangentImpulse=d.tangentImpulse;if(a){e.position=c.GetWorldPoint(f.localPoint1);c=c.GetLinearVelocityFromLocalPoint(f.localPoint1);b=b.GetLinearVelocityFromLocalPoint(f.localPoint2);
e.velocity.Set(b.x-c.x,b.y-c.y);e.normal.SetV(this.m_manifold.normal);e.separation=f.separation;e.id.key=f.id._key;a.Persist(e)}}}else{this.m_manifoldCount=0;if(this.m0.pointCount>0&&a){d=this.m0.points[0];e.position=c.GetWorldPoint(d.localPoint1);c=c.GetLinearVelocityFromLocalPoint(d.localPoint1);b=b.GetLinearVelocityFromLocalPoint(d.localPoint2);e.velocity.Set(b.x-c.x,b.y-c.y);e.normal.SetV(this.m0.normal);e.separation=d.separation;e.id.key=d.id._key;a.Remove(e)}}};
b2CircleContact.prototype.GetManifolds=function(){return this.m_manifolds};if(typeof exports!=="undefined"){exports.b2RevoluteJoint=b2RevoluteJoint;exports.b2PolygonShape=b2PolygonShape;exports.b2Island=b2Island;exports.b2OBB=b2OBB;exports.b2Distance=b2Distance;exports.b2Math=b2Math;exports.b2DistanceJoint=b2DistanceJoint;exports.b2ContactPoint=b2ContactPoint;exports.b2Bound=b2Bound;exports.b2DistanceJointDef=b2DistanceJointDef;exports.b2Body=b2Body;exports.b2CircleDef=b2CircleDef;exports.b2MouseJoint=b2MouseJoint;exports.b2CircleContact=b2CircleContact;exports.b2BodyDef=
b2BodyDef;exports.b2ContactListener=b2ContactListener;exports.b2ContactManager=b2ContactManager;exports.b2Settings=b2Settings;exports.b2Vec2=b2Vec2;exports.b2Proxy=b2Proxy;exports.b2AABB=b2AABB;exports.b2Pair=b2Pair;exports.b2TimeStep=b2TimeStep;exports.b2BroadPhase=b2BroadPhase;exports.b2Manifold=b2Manifold;exports.b2PolygonContact=b2PolygonContact;exports.b2World=b2World;exports.b2PrismaticJoint=b2PrismaticJoint;exports.b2Point=b2Point;exports.b2BufferedPair=b2BufferedPair;exports.b2ContactID=b2ContactID;
exports.b2RevoluteJointDef=b2RevoluteJointDef;exports.b2PairCallback=b2PairCallback;exports.b2TimeOfImpact=b2TimeOfImpact;exports.b2PulleyJointDef=b2PulleyJointDef;exports.b2CircleShape=b2CircleShape;exports.b2MassData=b2MassData;exports.b2Joint=b2Joint;exports.b2GearJoint=b2GearJoint;exports.b2Jacobian=b2Jacobian;exports.b2JointEdge=b2JointEdge;exports.b2GearJointDef=b2GearJointDef;exports.ClipVertex=ClipVertex;exports.b2Collision=b2Collision;exports.b2NullContact=b2NullContact;exports.b2Mat22=b2Mat22;
exports.b2ManifoldPoint=b2ManifoldPoint;exports.b2JointDef=b2JointDef;exports.b2BoundaryListener=b2BoundaryListener;exports.b2ShapeDef=b2ShapeDef;exports.b2Color=b2Color;exports.b2PairManager=b2PairManager;exports.b2ContactSolver=b2ContactSolver;exports.b2BoundValues=b2BoundValues;exports.b2PolygonDef=b2PolygonDef;exports.b2PolyAndCircleContact=b2PolyAndCircleContact;exports.b2PrismaticJointDef=b2PrismaticJointDef;exports.b2ContactResult=b2ContactResult;exports.Features=Features;exports.b2PulleyJoint=
b2PulleyJoint;exports.b2MouseJointDef=b2MouseJointDef;exports.b2XForm=b2XForm;exports.b2Shape=b2Shape;exports.b2ContactConstraintPoint=b2ContactConstraintPoint;exports.b2Segment=b2Segment;exports.b2ContactRegister=b2ContactRegister;exports.b2DestructionListener=b2DestructionListener;exports.b2FilterData=b2FilterData;exports.b2Contact=b2Contact;exports.b2DebugDraw=b2DebugDraw;exports.b2ContactFilter=b2ContactFilter;exports.b2ContactEdge=b2ContactEdge;exports.b2Sweep=b2Sweep;exports.b2ContactConstraint=
b2ContactConstraint};
